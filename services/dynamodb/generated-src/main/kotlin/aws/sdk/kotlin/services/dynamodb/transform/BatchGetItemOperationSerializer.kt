...
internal class BatchGetItemOperationSerializer: HttpSerialize<BatchGetItemRequest> {
    override suspend fun serialize(context: ExecutionContext, input: BatchGetItemRequest): HttpRequestBuilder {
        ...
        val payload = serializeBatchGetItemOperationBody(context, input)
...
private fun serializeBatchGetItemOperationBody(context: ExecutionContext, input: BatchGetItemRequest): ByteArray {
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        if (input.requestItems != null) {
            mapField(REQUESTITEMS_DESCRIPTOR) {
                input.requestItems.forEach { (key, value) -> entry(key, asSdkSerializable(value, ::serializeKeysAndAttributesDocument)) }
            }
        }
