 ...
 */
class AutoScalingTargetTrackingScalingPolicyConfigurationDescription private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): AutoScalingTargetTrackingScalingPolicyConfigurationDescription = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): AutoScalingTargetTrackingScalingPolicyConfigurationDescription = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): AutoScalingTargetTrackingScalingPolicyConfigurationDescription
        /**
         * Indicates whether scale in by the target tracking policy is disabled. If the value is true,
         * scale in is disabled and the target tracking policy won't remove capacity from the scalable resource.
         * Otherwise, scale in is enabled and the target tracking policy can remove capacity from the scalable resource.
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: AutoScalingTargetTrackingScalingPolicyConfigurationDescription) : this() {
        ...
        override fun build(): AutoScalingTargetTrackingScalingPolicyConfigurationDescription = AutoScalingTargetTrackingScalingPolicyConfigurationDescription(this)
