...
class EnableKinesisStreamingDestinationResponse private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): EnableKinesisStreamingDestinationResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): EnableKinesisStreamingDestinationResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): EnableKinesisStreamingDestinationResponse
        /**
         * The current status of the replication.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: EnableKinesisStreamingDestinationResponse) : this() {
            this.destinationStatus = x.destinationStatus
            this.streamArn = x.streamArn
            this.tableName = x.tableName
        }

        override fun build(): EnableKinesisStreamingDestinationResponse = EnableKinesisStreamingDestinationResponse(this)
