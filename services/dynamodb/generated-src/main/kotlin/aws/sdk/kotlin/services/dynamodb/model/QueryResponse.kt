 ...
 */
class QueryResponse private constructor(builder: BuilderImpl) {
    /**
     ...
     * Query operation. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/QueryAndScan.html#Count">Count and ScannedCount in the
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): QueryResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): QueryResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): QueryResponse
        /**
         * The capacity units consumed by the Query operation. The data returned
         * includes the total provisioned throughput consumed, along with statistics for the table
         * and any indexes involved in the operation. ConsumedCapacity is only
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: QueryResponse) : this() {
        ...
        override fun build(): QueryResponse = QueryResponse(this)
