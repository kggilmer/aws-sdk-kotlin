 ...
 */
class ExpectedAttributeValue private constructor(builder: BuilderImpl) {
    /**
     ...
     * is greater than B. For a list of code values, see <a href="http://en.wikipedia.org/wiki/ASCII#ASCII_printable_characters">http://en.wikipedia.org/wiki/ASCII#ASCII_printable_characters.
     * For Binary, DynamoDB treats each byte of the binary data as unsigned when it compares binary values.
     * For information on specifying data types in JSON, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataFormat.html">JSON Data Format in the Amazon DynamoDB Developer Guide.
     */
     ...
     * {"N":"6"} does not compare to {"NS":&#91;"6", "2", "1"&#93;}
     */
    val comparisonOperator: ComparisonOperator? = builder.comparisonOperator
    /**
     ...
     */
    val exists: Boolean? = builder.exists
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): ExpectedAttributeValue = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): ExpectedAttributeValue = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): ExpectedAttributeValue
        /**
         * One or more values to evaluate against the supplied attribute. The number of values in the
         * list depends on the ComparisonOperator being used.
         * For type Number, value comparisons are numeric.
         ...
         * For information on specifying data types in JSON, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataFormat.html">JSON Data Format in the Amazon DynamoDB Developer Guide.
         */
        fun attributeValueList(attributeValueList: List<AttributeValue>): FluentBuilder
        /**
         * A comparator for evaluating attributes in the AttributeValueList. For example, equals,
         * greater than, less than, etc.
         * The following comparison operators are available:
         ...
         * {"N":"6"} does not compare to {"NS":&#91;"6", "2", "1"&#93;}
         */
        fun comparisonOperator(comparisonOperator: ComparisonOperator): FluentBuilder
        /**
         * Causes DynamoDB to evaluate the value before attempting a conditional operation:
         * If Exists is true, DynamoDB will check to see if that attribute value
         * already exists in the table. If it is found, then the operation succeeds. If it is not
         ...
         * expect an attribute to have a value, while also expecting it not to exist.)
         */
        fun exists(exists: Boolean): FluentBuilder
        /**
         * Represents the data for the expected attribute.
         * Each attribute value is described as a name-value pair.  The name is the data type, and the value is the data itself.
         * For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.NamingRulesDataTypes.html#HowItWorks.DataTypes">Data Types in the
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        override var attributeValueList: List<AttributeValue>? = null
        override var comparisonOperator: ComparisonOperator? = null
        override var exists: Boolean? = null
        override var value: AttributeValue? = null

        constructor(x: ExpectedAttributeValue) : this() {
        ...
        override fun build(): ExpectedAttributeValue = ExpectedAttributeValue(this)
        override fun attributeValueList(attributeValueList: List<AttributeValue>): FluentBuilder = apply { this.attributeValueList = attributeValueList }
        override fun comparisonOperator(comparisonOperator: ComparisonOperator): FluentBuilder = apply { this.comparisonOperator = comparisonOperator }
        override fun exists(exists: Boolean): FluentBuilder = apply { this.exists = exists }
