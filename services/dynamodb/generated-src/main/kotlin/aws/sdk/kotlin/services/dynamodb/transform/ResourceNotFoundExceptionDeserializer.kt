...
internal class ResourceNotFoundExceptionDeserializer: HttpDeserialize<ResourceNotFoundException> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): ResourceNotFoundException {
        val builder = ResourceNotFoundException.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeResourceNotFoundExceptionError(builder, payload)
        }
