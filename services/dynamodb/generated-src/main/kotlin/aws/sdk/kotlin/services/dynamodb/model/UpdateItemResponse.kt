 ...
 */
class UpdateItemResponse private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): UpdateItemResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): UpdateItemResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): UpdateItemResponse
        /**
         * A map of attribute values as they appear before or after the UpdateItem
         * operation, as determined by the ReturnValues parameter.
         * The Attributes map is only present if ReturnValues was
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: UpdateItemResponse) : this() {
            this.attributes = x.attributes
            this.consumedCapacity = x.consumedCapacity
            this.itemCollectionMetrics = x.itemCollectionMetrics
        }

        override fun build(): UpdateItemResponse = UpdateItemResponse(this)
