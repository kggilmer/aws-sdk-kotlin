...
internal class DefaultDynamoDbClient(override val config: DynamoDbClient.Config) : DynamoDbClient {
    ...
    override suspend fun batchGetItem(input: BatchGetItemRequest): BatchGetItemResponse {
        val op = SdkHttpOperation.build<BatchGetItemRequest, BatchGetItemResponse> {
            serializer = BatchGetItemOperationSerializer()
            deserializer = BatchGetItemOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun batchWriteItem(input: BatchWriteItemRequest): BatchWriteItemResponse {
        val op = SdkHttpOperation.build<BatchWriteItemRequest, BatchWriteItemResponse> {
            serializer = BatchWriteItemOperationSerializer()
            deserializer = BatchWriteItemOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
    ...
    override suspend fun createBackup(input: CreateBackupRequest): CreateBackupResponse {
        val op = SdkHttpOperation.build<CreateBackupRequest, CreateBackupResponse> {
            serializer = CreateBackupOperationSerializer()
            deserializer = CreateBackupOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     * your global table.
     */
    override suspend fun createGlobalTable(input: CreateGlobalTableRequest): CreateGlobalTableResponse {
        val op = SdkHttpOperation.build<CreateGlobalTableRequest, CreateGlobalTableResponse> {
            serializer = CreateGlobalTableOperationSerializer()
            deserializer = CreateGlobalTableOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
    ...
    override suspend fun deleteBackup(input: DeleteBackupRequest): DeleteBackupResponse {
        val op = SdkHttpOperation.build<DeleteBackupRequest, DeleteBackupResponse> {
            serializer = DeleteBackupOperationSerializer()
            deserializer = DeleteBackupOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun deleteItem(input: DeleteItemRequest): DeleteItemResponse {
        val op = SdkHttpOperation.build<DeleteItemRequest, DeleteItemResponse> {
            serializer = DeleteItemOperationSerializer()
            deserializer = DeleteItemOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun describeBackup(input: DescribeBackupRequest): DescribeBackupResponse {
        val op = SdkHttpOperation.build<DescribeBackupRequest, DescribeBackupResponse> {
            serializer = DescribeBackupOperationSerializer()
            deserializer = DescribeBackupOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun describeContinuousBackups(input: DescribeContinuousBackupsRequest): DescribeContinuousBackupsResponse {
        val op = SdkHttpOperation.build<DescribeContinuousBackupsRequest, DescribeContinuousBackupsResponse> {
            serializer = DescribeContinuousBackupsOperationSerializer()
            deserializer = DescribeContinuousBackupsOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun describeContributorInsights(input: DescribeContributorInsightsRequest): DescribeContributorInsightsResponse {
        val op = SdkHttpOperation.build<DescribeContributorInsightsRequest, DescribeContributorInsightsResponse> {
            serializer = DescribeContributorInsightsOperationSerializer()
            deserializer = DescribeContributorInsightsOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun describeGlobalTable(input: DescribeGlobalTableRequest): DescribeGlobalTableResponse {
        val op = SdkHttpOperation.build<DescribeGlobalTableRequest, DescribeGlobalTableResponse> {
            serializer = DescribeGlobalTableOperationSerializer()
            deserializer = DescribeGlobalTableOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     * This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29 of global tables.
     */
    override suspend fun describeGlobalTableSettings(input: DescribeGlobalTableSettingsRequest): DescribeGlobalTableSettingsResponse {
        val op = SdkHttpOperation.build<DescribeGlobalTableSettingsRequest, DescribeGlobalTableSettingsResponse> {
            serializer = DescribeGlobalTableSettingsOperationSerializer()
            deserializer = DescribeGlobalTableSettingsOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun describeKinesisStreamingDestination(input: DescribeKinesisStreamingDestinationRequest): DescribeKinesisStreamingDestinationResponse {
        val op = SdkHttpOperation.build<DescribeKinesisStreamingDestinationRequest, DescribeKinesisStreamingDestinationResponse> {
            serializer = DescribeKinesisStreamingDestinationOperationSerializer()
            deserializer = DescribeKinesisStreamingDestinationOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun describeLimits(input: DescribeLimitsRequest): DescribeLimitsResponse {
        val op = SdkHttpOperation.build<DescribeLimitsRequest, DescribeLimitsResponse> {
            serializer = DescribeLimitsOperationSerializer()
            deserializer = DescribeLimitsOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun describeTableReplicaAutoScaling(input: DescribeTableReplicaAutoScalingRequest): DescribeTableReplicaAutoScalingResponse {
        val op = SdkHttpOperation.build<DescribeTableReplicaAutoScalingRequest, DescribeTableReplicaAutoScalingResponse> {
            serializer = DescribeTableReplicaAutoScalingOperationSerializer()
            deserializer = DescribeTableReplicaAutoScalingOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun describeTimeToLive(input: DescribeTimeToLiveRequest): DescribeTimeToLiveResponse {
        val op = SdkHttpOperation.build<DescribeTimeToLiveRequest, DescribeTimeToLiveResponse> {
            serializer = DescribeTimeToLiveOperationSerializer()
            deserializer = DescribeTimeToLiveOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun disableKinesisStreamingDestination(input: DisableKinesisStreamingDestinationRequest): DisableKinesisStreamingDestinationResponse {
        val op = SdkHttpOperation.build<DisableKinesisStreamingDestinationRequest, DisableKinesisStreamingDestinationResponse> {
            serializer = DisableKinesisStreamingDestinationOperationSerializer()
            deserializer = DisableKinesisStreamingDestinationOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     * ACTIVE.
     */
    override suspend fun enableKinesisStreamingDestination(input: EnableKinesisStreamingDestinationRequest): EnableKinesisStreamingDestinationResponse {
        val op = SdkHttpOperation.build<EnableKinesisStreamingDestinationRequest, EnableKinesisStreamingDestinationResponse> {
            serializer = EnableKinesisStreamingDestinationOperationSerializer()
            deserializer = EnableKinesisStreamingDestinationOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun executeTransaction(input: ExecuteTransactionRequest): ExecuteTransactionResponse {
        val op = SdkHttpOperation.build<ExecuteTransactionRequest, ExecuteTransactionResponse> {
            serializer = ExecuteTransactionOperationSerializer()
            deserializer = ExecuteTransactionOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     * window.
     */
    override suspend fun exportTableToPointInTime(input: ExportTableToPointInTimeRequest): ExportTableToPointInTimeResponse {
        val op = SdkHttpOperation.build<ExportTableToPointInTimeRequest, ExportTableToPointInTimeResponse> {
            serializer = ExportTableToPointInTimeOperationSerializer()
            deserializer = ExportTableToPointInTimeOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun getItem(input: GetItemRequest): GetItemResponse {
        val op = SdkHttpOperation.build<GetItemRequest, GetItemResponse> {
            serializer = GetItemOperationSerializer()
            deserializer = GetItemOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun listBackups(input: ListBackupsRequest): ListBackupsResponse {
        val op = SdkHttpOperation.build<ListBackupsRequest, ListBackupsResponse> {
            serializer = ListBackupsOperationSerializer()
            deserializer = ListBackupsOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun listContributorInsights(input: ListContributorInsightsRequest): ListContributorInsightsResponse {
        val op = SdkHttpOperation.build<ListContributorInsightsRequest, ListContributorInsightsResponse> {
            serializer = ListContributorInsightsOperationSerializer()
            deserializer = ListContributorInsightsOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     * This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29 of global tables.
     */
    override suspend fun listGlobalTables(input: ListGlobalTablesRequest): ListGlobalTablesResponse {
        val op = SdkHttpOperation.build<ListGlobalTablesRequest, ListGlobalTablesResponse> {
            serializer = ListGlobalTablesOperationSerializer()
            deserializer = ListGlobalTablesOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun listTagsOfResource(input: ListTagsOfResourceRequest): ListTagsOfResourceResponse {
        val op = SdkHttpOperation.build<ListTagsOfResourceRequest, ListTagsOfResourceResponse> {
            serializer = ListTagsOfResourceOperationSerializer()
            deserializer = ListTagsOfResourceOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
    ...
    override suspend fun putItem(input: PutItemRequest): PutItemResponse {
        val op = SdkHttpOperation.build<PutItemRequest, PutItemResponse> {
            serializer = PutItemOperationSerializer()
            deserializer = PutItemOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun restoreTableFromBackup(input: RestoreTableFromBackupRequest): RestoreTableFromBackupResponse {
        val op = SdkHttpOperation.build<RestoreTableFromBackupRequest, RestoreTableFromBackupResponse> {
            serializer = RestoreTableFromBackupOperationSerializer()
            deserializer = RestoreTableFromBackupOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun restoreTableToPointInTime(input: RestoreTableToPointInTimeRequest): RestoreTableToPointInTimeResponse {
        val op = SdkHttpOperation.build<RestoreTableToPointInTimeRequest, RestoreTableToPointInTimeResponse> {
            serializer = RestoreTableToPointInTimeOperationSerializer()
            deserializer = RestoreTableToPointInTimeOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     * parameter to true.
     */
    override suspend fun scan(input: ScanRequest): ScanResponse {
        val op = SdkHttpOperation.build<ScanRequest, ScanResponse> {
            serializer = ScanOperationSerializer()
            deserializer = ScanOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
                operationName = "Scan"
     ...
     */
    override suspend fun transactGetItems(input: TransactGetItemsRequest): TransactGetItemsResponse {
        val op = SdkHttpOperation.build<TransactGetItemsRequest, TransactGetItemsResponse> {
            serializer = TransactGetItemsOperationSerializer()
            deserializer = TransactGetItemsOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     * There  is a user error, such as an invalid data format.
     */
    override suspend fun transactWriteItems(input: TransactWriteItemsRequest): TransactWriteItemsResponse {
        val op = SdkHttpOperation.build<TransactWriteItemsRequest, TransactWriteItemsResponse> {
            serializer = TransactWriteItemsOperationSerializer()
            deserializer = TransactWriteItemsOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     * You can restore your table to any point in time during the last 35 days.
     */
    override suspend fun updateContinuousBackups(input: UpdateContinuousBackupsRequest): UpdateContinuousBackupsResponse {
        val op = SdkHttpOperation.build<UpdateContinuousBackupsRequest, UpdateContinuousBackupsResponse> {
            serializer = UpdateContinuousBackupsOperationSerializer()
            deserializer = UpdateContinuousBackupsOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun updateContributorInsights(input: UpdateContributorInsightsRequest): UpdateContributorInsightsResponse {
        val op = SdkHttpOperation.build<UpdateContributorInsightsRequest, UpdateContributorInsightsResponse> {
            serializer = UpdateContributorInsightsOperationSerializer()
            deserializer = UpdateContributorInsightsOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun updateGlobalTable(input: UpdateGlobalTableRequest): UpdateGlobalTableResponse {
        val op = SdkHttpOperation.build<UpdateGlobalTableRequest, UpdateGlobalTableResponse> {
            serializer = UpdateGlobalTableOperationSerializer()
            deserializer = UpdateGlobalTableOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun updateGlobalTableSettings(input: UpdateGlobalTableSettingsRequest): UpdateGlobalTableSettingsResponse {
        val op = SdkHttpOperation.build<UpdateGlobalTableSettingsRequest, UpdateGlobalTableSettingsResponse> {
            serializer = UpdateGlobalTableSettingsOperationSerializer()
            deserializer = UpdateGlobalTableSettingsOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     * operation using the ReturnValues parameter.
     */
    override suspend fun updateItem(input: UpdateItemRequest): UpdateItemResponse {
        val op = SdkHttpOperation.build<UpdateItemRequest, UpdateItemResponse> {
            serializer = UpdateItemOperationSerializer()
            deserializer = UpdateItemOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     * This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html">Version 2019.11.21 of global tables.
     */
    override suspend fun updateTableReplicaAutoScaling(input: UpdateTableReplicaAutoScalingRequest): UpdateTableReplicaAutoScalingResponse {
        val op = SdkHttpOperation.build<UpdateTableReplicaAutoScalingRequest, UpdateTableReplicaAutoScalingResponse> {
            serializer = UpdateTableReplicaAutoScalingOperationSerializer()
            deserializer = UpdateTableReplicaAutoScalingOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
     ...
     */
    override suspend fun updateTimeToLive(input: UpdateTimeToLiveRequest): UpdateTimeToLiveResponse {
        val op = SdkHttpOperation.build<UpdateTimeToLiveRequest, UpdateTimeToLiveResponse> {
            serializer = UpdateTimeToLiveOperationSerializer()
            deserializer = UpdateTimeToLiveOperationDeserializer()
            context {
                expectedHttpStatus = 200
                service = serviceName
