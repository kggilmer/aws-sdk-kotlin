 ...
 */
class GlobalSecondaryIndexInfo private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): GlobalSecondaryIndexInfo = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): GlobalSecondaryIndexInfo = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): GlobalSecondaryIndexInfo
        /**
         * The name of the global secondary index.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: GlobalSecondaryIndexInfo) : this() {
        ...
        override fun build(): GlobalSecondaryIndexInfo = GlobalSecondaryIndexInfo(this)
