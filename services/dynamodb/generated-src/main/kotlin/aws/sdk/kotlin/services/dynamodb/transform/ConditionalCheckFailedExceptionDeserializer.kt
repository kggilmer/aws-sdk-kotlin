...
internal class ConditionalCheckFailedExceptionDeserializer: HttpDeserialize<ConditionalCheckFailedException> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): ConditionalCheckFailedException {
        val builder = ConditionalCheckFailedException.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeConditionalCheckFailedExceptionError(builder, payload)
        }
