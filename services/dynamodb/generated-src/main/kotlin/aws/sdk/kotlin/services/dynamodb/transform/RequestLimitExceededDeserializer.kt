...
internal class RequestLimitExceededDeserializer: HttpDeserialize<RequestLimitExceeded> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): RequestLimitExceeded {
