 ...
 */
interface DynamoDbClient : SdkClient {
    ...
    companion object {
        operator fun invoke(sharedConfig: AwsClientConfig? = null, block: Config.DslBuilder.() -> Unit = {}): DynamoDbClient {
        ...
        operator fun invoke(config: Config): DynamoDbClient = DefaultDynamoDbClient(config)
         ...
         */
        suspend fun fromEnvironment(block: AwsClientConfigLoadOptions.() -> Unit = {}): DynamoDbClient {
            val sharedConfig = AwsClientConfig.fromEnvironment(block)
            return DynamoDbClient(sharedConfig)
        }
    }
     ...
     * Guide.
     */
    suspend fun batchGetItem(input: BatchGetItemRequest): BatchGetItemResponse
     ...
     * Guide.
     */
    suspend fun batchGetItem(block: BatchGetItemRequest.DslBuilder.() -> Unit) = batchGetItem(BatchGetItemRequest.builder().apply(block).build())
     ...
     */
    suspend fun batchWriteItem(input: BatchWriteItemRequest): BatchWriteItemResponse
     ...
     * The total request size exceeds 16 MB.
     */
    suspend fun batchWriteItem(block: BatchWriteItemRequest.DslBuilder.() -> Unit) = batchWriteItem(BatchWriteItemRequest.builder().apply(block).build())
     ...
     */
    suspend fun createBackup(input: CreateBackupRequest): CreateBackupResponse
     ...
     * Provisioned read and write capacity
     */
    suspend fun createBackup(block: CreateBackupRequest.DslBuilder.() -> Unit) = createBackup(CreateBackupRequest.builder().apply(block).build())
     ...
     * your global table.
     */
    suspend fun createGlobalTable(input: CreateGlobalTableRequest): CreateGlobalTableResponse
     ...
     * your global table.
     */
    suspend fun createGlobalTable(block: CreateGlobalTableRequest.DslBuilder.() -> Unit) = createGlobalTable(CreateGlobalTableRequest.builder().apply(block).build())
     ...
     * You can use the DescribeTable action to check the table status.
     */
    suspend fun createTable(block: CreateTableRequest.DslBuilder.() -> Unit) = createTable(CreateTableRequest.builder().apply(block).build())

    /**
     * Deletes an existing backup of a table.
     * You can call DeleteBackup at a maximum rate of 10 times per second.
     */
    suspend fun deleteBackup(input: DeleteBackupRequest): DeleteBackupResponse

    /**
     * Deletes an existing backup of a table.
     * You can call DeleteBackup at a maximum rate of 10 times per second.
     */
    suspend fun deleteBackup(block: DeleteBackupRequest.DslBuilder.() -> Unit) = deleteBackup(DeleteBackupRequest.builder().apply(block).build())
     ...
     */
    suspend fun deleteItem(input: DeleteItemRequest): DeleteItemResponse
     ...
     * Conditional deletes are useful for deleting items only if specific conditions are met. If those conditions are met, DynamoDB performs the delete. Otherwise, the item is not deleted.
     */
    suspend fun deleteItem(block: DeleteItemRequest.DslBuilder.() -> Unit) = deleteItem(DeleteItemRequest.builder().apply(block).build())
     ...
     * Use the DescribeTable action to check the status of the table.
     */
    suspend fun deleteTable(block: DeleteTableRequest.DslBuilder.() -> Unit) = deleteTable(DeleteTableRequest.builder().apply(block).build())

    /**
     * Describes an existing backup of a table.
     * You can call DescribeBackup at a maximum rate of 10 times per second.
     */
    suspend fun describeBackup(input: DescribeBackupRequest): DescribeBackupResponse

    /**
     * Describes an existing backup of a table.
     * You can call DescribeBackup at a maximum rate of 10 times per second.
     */
    suspend fun describeBackup(block: DescribeBackupRequest.DslBuilder.() -> Unit) = describeBackup(DescribeBackupRequest.builder().apply(block).build())
     ...
     */
    suspend fun describeContinuousBackups(input: DescribeContinuousBackupsRequest): DescribeContinuousBackupsResponse
     ...
     * You can call DescribeContinuousBackups at a maximum rate of 10 times per second.
     */
    suspend fun describeContinuousBackups(block: DescribeContinuousBackupsRequest.DslBuilder.() -> Unit) = describeContinuousBackups(DescribeContinuousBackupsRequest.builder().apply(block).build())

    /**
     * Returns information about contributor insights, for a given table or global secondary index.
     */
    suspend fun describeContributorInsights(input: DescribeContributorInsightsRequest): DescribeContributorInsightsResponse

    /**
     * Returns information about contributor insights, for a given table or global secondary index.
     */
    suspend fun describeContributorInsights(block: DescribeContributorInsightsRequest.DslBuilder.() -> Unit) = describeContributorInsights(DescribeContributorInsightsRequest.builder().apply(block).build())
     ...
     * Returns the regional endpoint information.
     */
    suspend fun describeEndpoints(block: DescribeEndpointsRequest.DslBuilder.() -> Unit) = describeEndpoints(DescribeEndpointsRequest.builder().apply(block).build())
     ...
     * Describes an existing table export.
     */
    suspend fun describeExport(block: DescribeExportRequest.DslBuilder.() -> Unit) = describeExport(DescribeExportRequest.builder().apply(block).build())
     ...
     */
    suspend fun describeGlobalTable(input: DescribeGlobalTableRequest): DescribeGlobalTableResponse
     ...
     * If you are using global tables <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html">Version 2019.11.21 you can use <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_DescribeTable.html">DescribeTable instead.
     */
    suspend fun describeGlobalTable(block: DescribeGlobalTableRequest.DslBuilder.() -> Unit) = describeGlobalTable(DescribeGlobalTableRequest.builder().apply(block).build())

    /**
     * Describes Region-specific settings for a global table.
     * This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29 of global tables.
     */
    suspend fun describeGlobalTableSettings(input: DescribeGlobalTableSettingsRequest): DescribeGlobalTableSettingsResponse

    /**
     * Describes Region-specific settings for a global table.
     * This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29 of global tables.
     */
    suspend fun describeGlobalTableSettings(block: DescribeGlobalTableSettingsRequest.DslBuilder.() -> Unit) = describeGlobalTableSettings(DescribeGlobalTableSettingsRequest.builder().apply(block).build())

    /**
     * Returns information about the status of Kinesis streaming.
     */
    suspend fun describeKinesisStreamingDestination(input: DescribeKinesisStreamingDestinationRequest): DescribeKinesisStreamingDestinationResponse

    /**
     * Returns information about the status of Kinesis streaming.
     */
    suspend fun describeKinesisStreamingDestination(block: DescribeKinesisStreamingDestinationRequest.DslBuilder.() -> Unit) = describeKinesisStreamingDestination(DescribeKinesisStreamingDestinationRequest.builder().apply(block).build())
     ...
     */
    suspend fun describeLimits(input: DescribeLimitsRequest): DescribeLimitsResponse
     ...
     * The DescribeLimits Request element has no content.
     */
    suspend fun describeLimits(block: DescribeLimitsRequest.DslBuilder.() -> Unit) = describeLimits(DescribeLimitsRequest.builder().apply(block).build())
     ...
     */
    suspend fun describeTableReplicaAutoScaling(input: DescribeTableReplicaAutoScalingRequest): DescribeTableReplicaAutoScalingResponse

    /**
     * Describes auto scaling settings across replicas of the global table at once.
     * This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html">Version 2019.11.21 of global tables.
     */
    suspend fun describeTableReplicaAutoScaling(block: DescribeTableReplicaAutoScalingRequest.DslBuilder.() -> Unit) = describeTableReplicaAutoScaling(DescribeTableReplicaAutoScalingRequest.builder().apply(block).build())

    /**
     * Gives a description of the Time to Live (TTL) status on the specified table.
     */
    suspend fun describeTimeToLive(input: DescribeTimeToLiveRequest): DescribeTimeToLiveResponse

    /**
     * Gives a description of the Time to Live (TTL) status on the specified table.
     */
    suspend fun describeTimeToLive(block: DescribeTimeToLiveRequest.DslBuilder.() -> Unit) = describeTimeToLive(DescribeTimeToLiveRequest.builder().apply(block).build())
     ...
     */
    suspend fun disableKinesisStreamingDestination(input: DisableKinesisStreamingDestinationRequest): DisableKinesisStreamingDestinationResponse

    /**
     * Stops replication from the DynamoDB table to the Kinesis data stream. This is done
     * without deleting either of the resources.
     */
    suspend fun disableKinesisStreamingDestination(block: DisableKinesisStreamingDestinationRequest.DslBuilder.() -> Unit) = disableKinesisStreamingDestination(DisableKinesisStreamingDestinationRequest.builder().apply(block).build())
     ...
     * ACTIVE.
     */
    suspend fun enableKinesisStreamingDestination(input: EnableKinesisStreamingDestinationRequest): EnableKinesisStreamingDestinationResponse
     ...
     * ACTIVE.
     */
    suspend fun enableKinesisStreamingDestination(block: EnableKinesisStreamingDestinationRequest.DslBuilder.() -> Unit) = enableKinesisStreamingDestination(EnableKinesisStreamingDestinationRequest.builder().apply(block).build())
     ...
     */
    suspend fun executeTransaction(input: ExecuteTransactionRequest): ExecuteTransactionResponse

    /**
     * This operation allows you to perform transactional reads or writes on data stored in DynamoDB, using PartiQL.
     */
    suspend fun executeTransaction(block: ExecuteTransactionRequest.DslBuilder.() -> Unit) = executeTransaction(ExecuteTransactionRequest.builder().apply(block).build())
     ...
     * window.
     */
    suspend fun exportTableToPointInTime(input: ExportTableToPointInTimeRequest): ExportTableToPointInTimeResponse
     ...
     * window.
     */
    suspend fun exportTableToPointInTime(block: ExportTableToPointInTimeRequest.DslBuilder.() -> Unit) = exportTableToPointInTime(ExportTableToPointInTimeRequest.builder().apply(block).build())
     ...
     */
    suspend fun getItem(input: GetItemRequest): GetItemResponse
     ...
     * returns the last updated value.
     */
    suspend fun getItem(block: GetItemRequest.DslBuilder.() -> Unit) = getItem(GetItemRequest.builder().apply(block).build())
     ...
     */
    suspend fun listBackups(input: ListBackupsRequest): ListBackupsResponse
     ...
     * You can call ListBackups a maximum of five times per second.
     */
    suspend fun listBackups(block: ListBackupsRequest.DslBuilder.() -> Unit) = listBackups(ListBackupsRequest.builder().apply(block).build())

    /**
     * Returns a list of ContributorInsightsSummary for a table and all its global secondary indexes.
     */
    suspend fun listContributorInsights(input: ListContributorInsightsRequest): ListContributorInsightsResponse

    /**
     * Returns a list of ContributorInsightsSummary for a table and all its global secondary indexes.
     */
    suspend fun listContributorInsights(block: ListContributorInsightsRequest.DslBuilder.() -> Unit) = listContributorInsights(ListContributorInsightsRequest.builder().apply(block).build())
     ...
     * Lists completed exports within the past 90 days.
     */
    suspend fun listExports(block: ListExportsRequest.DslBuilder.() -> Unit) = listExports(ListExportsRequest.builder().apply(block).build())

    /**
     * Lists all global tables that have a replica in the specified Region.
     * This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29 of global tables.
     */
    suspend fun listGlobalTables(input: ListGlobalTablesRequest): ListGlobalTablesResponse

    /**
     * Lists all global tables that have a replica in the specified Region.
     * This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V1.html">Version 2017.11.29 of global tables.
     */
    suspend fun listGlobalTables(block: ListGlobalTablesRequest.DslBuilder.() -> Unit) = listGlobalTables(ListGlobalTablesRequest.builder().apply(block).build())
     ...
     */
    suspend fun listTagsOfResource(input: ListTagsOfResourceRequest): ListTagsOfResourceResponse
     ...
     * in the Amazon DynamoDB Developer Guide.
     */
    suspend fun listTagsOfResource(block: ListTagsOfResourceRequest.DslBuilder.() -> Unit) = listTagsOfResource(ListTagsOfResourceRequest.builder().apply(block).build())
     ...
     */
    suspend fun putItem(input: PutItemRequest): PutItemResponse
     ...
     * For more information about PutItem, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithItems.html">Working with Items in the Amazon DynamoDB Developer Guide.
     */
    suspend fun putItem(block: PutItemRequest.DslBuilder.() -> Unit) = putItem(PutItemRequest.builder().apply(block).build())
     ...
     * secondary index.
     */
    suspend fun query(block: QueryRequest.DslBuilder.() -> Unit) = query(QueryRequest.builder().apply(block).build())
     ...
     */
    suspend fun restoreTableFromBackup(input: RestoreTableFromBackupRequest): RestoreTableFromBackupResponse
     ...
     * Time to Live (TTL) settings
     */
    suspend fun restoreTableFromBackup(block: RestoreTableFromBackupRequest.DslBuilder.() -> Unit) = restoreTableFromBackup(RestoreTableFromBackupRequest.builder().apply(block).build())
     ...
     */
    suspend fun restoreTableToPointInTime(input: RestoreTableToPointInTimeRequest): RestoreTableToPointInTimeResponse
     ...
     * Point in time recovery settings
     */
    suspend fun restoreTableToPointInTime(block: RestoreTableToPointInTimeRequest.DslBuilder.() -> Unit) = restoreTableToPointInTime(RestoreTableToPointInTimeRequest.builder().apply(block).build())
     ...
     * parameter to true.
     */
    suspend fun scan(input: ScanRequest): ScanResponse
     ...
     * parameter to true.
     */
    suspend fun scan(block: ScanRequest.DslBuilder.() -> Unit) = scan(ScanRequest.builder().apply(block).build())
     ...
     */
    suspend fun transactGetItems(input: TransactGetItemsRequest): TransactGetItemsResponse
     ...
     * The aggregate size of the items in the transaction cannot exceed 4 MB.
     */
    suspend fun transactGetItems(block: TransactGetItemsRequest.DslBuilder.() -> Unit) = transactGetItems(TransactGetItemsRequest.builder().apply(block).build())
     ...
     * There  is a user error, such as an invalid data format.
     */
    suspend fun transactWriteItems(input: TransactWriteItemsRequest): TransactWriteItemsResponse
     ...
     * There  is a user error, such as an invalid data format.
     */
    suspend fun transactWriteItems(block: TransactWriteItemsRequest.DslBuilder.() -> Unit) = transactWriteItems(TransactWriteItemsRequest.builder().apply(block).build())
     ...
     * You can restore your table to any point in time during the last 35 days.
     */
    suspend fun updateContinuousBackups(input: UpdateContinuousBackupsRequest): UpdateContinuousBackupsResponse
     ...
     * You can restore your table to any point in time during the last 35 days.
     */
    suspend fun updateContinuousBackups(block: UpdateContinuousBackupsRequest.DslBuilder.() -> Unit) = updateContinuousBackups(UpdateContinuousBackupsRequest.builder().apply(block).build())

    /**
     * Updates the status for contributor insights for a specific table or index.
     */
    suspend fun updateContributorInsights(input: UpdateContributorInsightsRequest): UpdateContributorInsightsResponse

    /**
     * Updates the status for contributor insights for a specific table or index.
     */
    suspend fun updateContributorInsights(block: UpdateContributorInsightsRequest.DslBuilder.() -> Unit) = updateContributorInsights(UpdateContributorInsightsRequest.builder().apply(block).build())
     ...
     */
    suspend fun updateGlobalTable(input: UpdateGlobalTableRequest): UpdateGlobalTableResponse
     ...
     * The global secondary indexes must have the same provisioned and maximum write capacity units.
     */
    suspend fun updateGlobalTable(block: UpdateGlobalTableRequest.DslBuilder.() -> Unit) = updateGlobalTable(UpdateGlobalTableRequest.builder().apply(block).build())

    /**
     * Updates settings for a global table.
     */
    suspend fun updateGlobalTableSettings(input: UpdateGlobalTableSettingsRequest): UpdateGlobalTableSettingsResponse

    /**
     * Updates settings for a global table.
     */
    suspend fun updateGlobalTableSettings(block: UpdateGlobalTableSettingsRequest.DslBuilder.() -> Unit) = updateGlobalTableSettings(UpdateGlobalTableSettingsRequest.builder().apply(block).build())
     ...
     * operation using the ReturnValues parameter.
     */
    suspend fun updateItem(input: UpdateItemRequest): UpdateItemResponse
     ...
     * operation using the ReturnValues parameter.
     */
    suspend fun updateItem(block: UpdateItemRequest.DslBuilder.() -> Unit) = updateItem(UpdateItemRequest.builder().apply(block).build())
     ...
     * ACTIVE state, the UpdateTable operation is complete.
     */
    suspend fun updateTable(block: UpdateTableRequest.DslBuilder.() -> Unit) = updateTable(UpdateTableRequest.builder().apply(block).build())

    /**
     * Updates auto scaling settings on your global tables at once.
     * This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html">Version 2019.11.21 of global tables.
     */
    suspend fun updateTableReplicaAutoScaling(input: UpdateTableReplicaAutoScalingRequest): UpdateTableReplicaAutoScalingResponse

    /**
     * Updates auto scaling settings on your global tables at once.
     * This operation only applies to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html">Version 2019.11.21 of global tables.
     */
    suspend fun updateTableReplicaAutoScaling(block: UpdateTableReplicaAutoScalingRequest.DslBuilder.() -> Unit) = updateTableReplicaAutoScaling(UpdateTableReplicaAutoScalingRequest.builder().apply(block).build())
     ...
     */
    suspend fun updateTimeToLive(input: UpdateTimeToLiveRequest): UpdateTimeToLiveResponse
     ...
     * For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/TTL.html">Time To Live in the Amazon DynamoDB Developer Guide.
     */
    suspend fun updateTimeToLive(block: UpdateTimeToLiveRequest.DslBuilder.() -> Unit) = updateTimeToLive(UpdateTimeToLiveRequest.builder().apply(block).build())
}
