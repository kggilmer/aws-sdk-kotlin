...
class DescribeGlobalTableResponse private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): DescribeGlobalTableResponse = BuilderImpl().apply(block).build()

    }

    override fun toString(): kotlin.String = buildString {
        append("DescribeGlobalTableResponse(")
    ...
    override fun equals(other: kotlin.Any?): kotlin.Boolean {
        ...
        other as DescribeGlobalTableResponse
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): DescribeGlobalTableResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): DescribeGlobalTableResponse
        /**
         * Contains the details of the global table.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: DescribeGlobalTableResponse) : this() {
            this.globalTableDescription = x.globalTableDescription
        }

        override fun build(): DescribeGlobalTableResponse = DescribeGlobalTableResponse(this)
