...
internal class PutItemOperationSerializer: HttpSerialize<PutItemRequest> {
    override suspend fun serialize(context: ExecutionContext, input: PutItemRequest): HttpRequestBuilder {
        ...
        val payload = serializePutItemOperationBody(context, input)
...
private fun serializePutItemOperationBody(context: ExecutionContext, input: PutItemRequest): ByteArray {
