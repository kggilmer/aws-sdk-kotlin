...
internal class BatchWriteItemOperationDeserializer: HttpDeserialize<BatchWriteItemResponse> {
    ...
    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): BatchWriteItemResponse {
        if (!response.status.isSuccess()) {
            throwBatchWriteItemError(context, response)
        }
...
private suspend fun deserializeBatchWriteItemOperationBody(builder: BatchWriteItemResponse.DslBuilder, payload: ByteArray) {
...
private suspend fun throwBatchWriteItemError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
    val payload = response.body.readAll()
