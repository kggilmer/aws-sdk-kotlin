 ...
 */
class BatchWriteItemResponse private constructor(builder: BuilderImpl) {
    /**
     ...
     */
    val unprocessedItems: Map<String, List<WriteRequest>>? = builder.unprocessedItems
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): BatchWriteItemResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): BatchWriteItemResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): BatchWriteItemResponse
        /**
         * The capacity units consumed by the entire BatchWriteItem operation.
         * Each element consists of:
         * TableName - The table that consumed the provisioned throughput.
         ...
         * UnprocessedItems map.
         */
        fun unprocessedItems(unprocessedItems: Map<String, List<WriteRequest>>): FluentBuilder
    }
    ...
    interface DslBuilder {
         ...
         * UnprocessedItems map.
         */
        var unprocessedItems: Map<String, List<WriteRequest>>?
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        override var unprocessedItems: Map<String, List<WriteRequest>>? = null

        constructor(x: BatchWriteItemResponse) : this() {
        ...
        override fun build(): BatchWriteItemResponse = BatchWriteItemResponse(this)
        ...
        override fun unprocessedItems(unprocessedItems: Map<String, List<WriteRequest>>): FluentBuilder = apply { this.unprocessedItems = unprocessedItems }
    }
}
