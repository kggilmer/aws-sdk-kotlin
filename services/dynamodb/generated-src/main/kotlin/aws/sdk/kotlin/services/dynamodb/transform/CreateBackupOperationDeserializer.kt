...
private suspend fun deserializeCreateBackupOperationBody(builder: CreateBackupResponse.DslBuilder, payload: ByteArray) {
...
private suspend fun throwCreateBackupError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
    ...
    val modeledExceptionDeserializer = when(errorDetails.code) {
        ...
        "ContinuousBackupsUnavailableException" -> ContinuousBackupsUnavailableExceptionDeserializer()
