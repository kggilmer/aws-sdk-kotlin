 ...
 */
class TransactionCanceledException private constructor(builder: BuilderImpl) : DynamoDbException() {
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): TransactionCanceledException = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): TransactionCanceledException = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): TransactionCanceledException
        /**
         * A list of cancellation reasons.
         */
        fun cancellationReasons(cancellationReasons: List<CancellationReason>): FluentBuilder
    ...
    interface DslBuilder {
         ...
         * A list of cancellation reasons.
         */
        var cancellationReasons: List<CancellationReason>?
        var message: String?
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        override var cancellationReasons: List<CancellationReason>? = null
        override var message: String? = null

        constructor(x: TransactionCanceledException) : this() {
            this.cancellationReasons = x.cancellationReasons
            this.message = x.message
        }

        override fun build(): TransactionCanceledException = TransactionCanceledException(this)
        override fun cancellationReasons(cancellationReasons: List<CancellationReason>): FluentBuilder = apply { this.cancellationReasons = cancellationReasons }
