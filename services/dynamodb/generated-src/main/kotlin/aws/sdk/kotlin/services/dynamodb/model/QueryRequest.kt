 ...
 */
class QueryRequest private constructor(builder: BuilderImpl) {
    /**
     ...
     * For more information on expression attribute values, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.SpecifyingConditions.html">Specifying Conditions in the Amazon DynamoDB Developer Guide.
     */
     ...
     */
    val keyConditionExpression: String? = builder.keyConditionExpression
    /**
     * This is a legacy parameter.  Use KeyConditionExpression instead.   For more information, see
     * <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.KeyConditions.html">KeyConditions in the Amazon DynamoDB Developer Guide.
     */
    ...
    /**
     * This is a legacy parameter.  Use FilterExpression instead.   For more information, see
     * <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.QueryFilter.html">QueryFilter in the Amazon DynamoDB Developer Guide.
     */
     ...
     */
    val scanIndexForward: Boolean? = builder.scanIndexForward
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): QueryRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): QueryRequest = BuilderImpl(this).apply(block).build()
    ...
    interface FluentBuilder {
         ...
         * Names and Values in the Amazon DynamoDB Developer Guide.
         */
        fun keyConditionExpression(keyConditionExpression: String): FluentBuilder
        /**
         * This is a legacy parameter.  Use KeyConditionExpression instead.   For more information, see
         * <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.KeyConditions.html">KeyConditions in the Amazon DynamoDB Developer Guide.
         */
        fun keyConditions(keyConditions: Map<String, Condition>): FluentBuilder
        /**
         * The maximum number of items to evaluate (not necessarily the number of matching items).
         * If DynamoDB processes the number of items up to the limit while processing the results,
         * it stops the operation and returns the matching values up to that point, and a key in
         ...
         * <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.QueryFilter.html">QueryFilter in the Amazon DynamoDB Developer Guide.
         */
        fun queryFilter(queryFilter: Map<String, Condition>): FluentBuilder
        /**
         * Determines the level of detail about provisioned throughput consumption that is returned in the response:
         * INDEXES - The response includes the aggregate ConsumedCapacity for the operation, together with ConsumedCapacity for each table and secondary index that was accessed.
         * Note that some operations, such as GetItem and BatchGetItem, do not access any indexes at all.  In these cases, specifying INDEXES will only return ConsumedCapacity information for table(s).
         ...
         * If ScanIndexForward is true, DynamoDB returns the results in the order in which they are stored (by sort key value). This is the default behavior. If ScanIndexForward is false, DynamoDB reads the results in reverse order by sort key value, and then returns the results to the client.
         */
        fun scanIndexForward(scanIndexForward: Boolean): FluentBuilder
        /**
         * The attributes to be returned in the
         * result. You can retrieve all item attributes, specific item attributes, the count of
         * matching items, or in the case of an index, some or all of the attributes projected into
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        override var keyConditionExpression: String? = null
        override var keyConditions: Map<String, Condition>? = null
        override var limit: Int? = null
        override var projectionExpression: String? = null
        override var queryFilter: Map<String, Condition>? = null
        override var returnConsumedCapacity: ReturnConsumedCapacity? = null
        override var scanIndexForward: Boolean? = null
        override var select: Select? = null
        override var tableName: String? = null

        constructor(x: QueryRequest) : this() {
        ...
        override fun build(): QueryRequest = QueryRequest(this)
        ...
        override fun keyConditionExpression(keyConditionExpression: String): FluentBuilder = apply { this.keyConditionExpression = keyConditionExpression }
        override fun keyConditions(keyConditions: Map<String, Condition>): FluentBuilder = apply { this.keyConditions = keyConditions }
        ...
        override fun queryFilter(queryFilter: Map<String, Condition>): FluentBuilder = apply { this.queryFilter = queryFilter }
        ...
        override fun scanIndexForward(scanIndexForward: Boolean): FluentBuilder = apply { this.scanIndexForward = scanIndexForward }
