...
internal class InvalidLexiconExceptionDeserializer: HttpDeserialize<InvalidLexiconException> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): InvalidLexiconException {
        val builder = InvalidLexiconException.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeInvalidLexiconExceptionError(builder, payload)
        }
