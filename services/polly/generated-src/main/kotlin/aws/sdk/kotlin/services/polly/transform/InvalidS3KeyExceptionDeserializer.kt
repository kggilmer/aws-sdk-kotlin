...
internal class InvalidS3KeyExceptionDeserializer: HttpDeserialize<InvalidS3KeyException> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): InvalidS3KeyException {
        val builder = InvalidS3KeyException.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeInvalidS3KeyExceptionError(builder, payload)
        }
