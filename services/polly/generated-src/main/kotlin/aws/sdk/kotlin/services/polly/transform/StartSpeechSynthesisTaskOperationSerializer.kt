...
internal class StartSpeechSynthesisTaskOperationSerializer: HttpSerialize<StartSpeechSynthesisTaskRequest> {
    override suspend fun serialize(context: ExecutionContext, input: StartSpeechSynthesisTaskRequest): HttpRequestBuilder {
        ...
        val payload = serializeStartSpeechSynthesisTaskOperationBody(context, input)
...
private fun serializeStartSpeechSynthesisTaskOperationBody(context: ExecutionContext, input: StartSpeechSynthesisTaskRequest): ByteArray {
