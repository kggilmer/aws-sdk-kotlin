...
class GetFederationTokenRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): GetFederationTokenRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): GetFederationTokenRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): GetFederationTokenRequest
        /**
         * The duration, in seconds, that the session should last. Acceptable durations for
         * federation sessions range from 900 seconds (15 minutes) to 129,600 seconds (36 hours), with
         * 43,200 seconds (12 hours) as the default. Sessions obtained using Amazon Web Services account root user
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: GetFederationTokenRequest) : this() {
        ...
        override fun build(): GetFederationTokenRequest = GetFederationTokenRequest(this)
