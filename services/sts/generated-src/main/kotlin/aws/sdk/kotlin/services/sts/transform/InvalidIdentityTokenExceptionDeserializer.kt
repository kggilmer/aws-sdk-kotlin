...
import aws.sdk.kotlin.services.sts.model.InvalidIdentityTokenException
...
internal class InvalidIdentityTokenExceptionDeserializer: HttpDeserialize<InvalidIdentityTokenException> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): InvalidIdentityTokenException {
        val builder = InvalidIdentityTokenException.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeInvalidIdentityTokenExceptionError(builder, payload)
        }
