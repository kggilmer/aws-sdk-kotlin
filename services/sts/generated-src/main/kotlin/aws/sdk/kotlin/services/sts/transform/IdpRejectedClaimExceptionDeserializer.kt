...
import aws.sdk.kotlin.services.sts.model.IdpRejectedClaimException
...
internal class IdpRejectedClaimExceptionDeserializer: HttpDeserialize<IdpRejectedClaimException> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): IdpRejectedClaimException {
        val builder = IdpRejectedClaimException.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeIdpRejectedClaimExceptionError(builder, payload)
        }
