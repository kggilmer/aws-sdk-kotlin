...
import aws.sdk.kotlin.services.sts.model.IdpCommunicationErrorException
...
internal class IdpCommunicationErrorExceptionDeserializer: HttpDeserialize<IdpCommunicationErrorException> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): IdpCommunicationErrorException {
        val builder = IdpCommunicationErrorException.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeIdpCommunicationErrorExceptionError(builder, payload)
        }
