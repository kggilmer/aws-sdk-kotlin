...
import aws.sdk.kotlin.services.sts.model.RegionDisabledException
...
internal class RegionDisabledExceptionDeserializer: HttpDeserialize<RegionDisabledException> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): RegionDisabledException {
        val builder = RegionDisabledException.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeRegionDisabledExceptionError(builder, payload)
        }
