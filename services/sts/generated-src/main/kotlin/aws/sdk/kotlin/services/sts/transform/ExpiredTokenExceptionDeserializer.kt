...
import aws.sdk.kotlin.services.sts.model.ExpiredTokenException
...
internal class ExpiredTokenExceptionDeserializer: HttpDeserialize<ExpiredTokenException> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): ExpiredTokenException {
        val builder = ExpiredTokenException.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeExpiredTokenExceptionError(builder, payload)
        }
