...
internal class AuthorizeSecurityGroupIngressOperationSerializer: HttpSerialize<AuthorizeSecurityGroupIngressRequest> {
    override suspend fun serialize(context: ExecutionContext, input: AuthorizeSecurityGroupIngressRequest): HttpRequestBuilder {
        ...
        val payload = serializeAuthorizeSecurityGroupIngressOperationBody(context, input)
...
private fun serializeAuthorizeSecurityGroupIngressOperationBody(context: ExecutionContext, input: AuthorizeSecurityGroupIngressRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("AuthorizeSecurityGroupIngressRequest"))
        trait(QueryLiteral("Action", "AuthorizeSecurityGroupIngress"))
