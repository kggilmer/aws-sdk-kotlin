...
internal class DescribeClientVpnRoutesOperationSerializer: HttpSerialize<DescribeClientVpnRoutesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeClientVpnRoutesRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeClientVpnRoutesOperationBody(context, input)
...
private fun serializeDescribeClientVpnRoutesOperationBody(context: ExecutionContext, input: DescribeClientVpnRoutesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeClientVpnRoutesRequest"))
        trait(QueryLiteral("Action", "DescribeClientVpnRoutes"))
