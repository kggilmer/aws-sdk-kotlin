...
internal fun serializeLaunchTemplateBlockDeviceMappingRequestDocument(serializer: Serializer, input: LaunchTemplateBlockDeviceMappingRequest) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("LaunchTemplateBlockDeviceMappingRequest"))
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.ebs?.let { field(EBS_DESCRIPTOR, it, ::serializeLaunchTemplateEbsBlockDeviceRequestDocument) }
