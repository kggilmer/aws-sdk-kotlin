...
internal fun serializePhase1EncryptionAlgorithmsRequestListValueDocument(serializer: Serializer, input: Phase1EncryptionAlgorithmsRequestListValue) {
    val VALUE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, FormUrlSerialName("Value"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("Phase1EncryptionAlgorithmsRequestListValue"))
