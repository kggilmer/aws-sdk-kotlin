...
internal class GetTransitGatewayPrefixListReferencesOperationSerializer: HttpSerialize<GetTransitGatewayPrefixListReferencesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetTransitGatewayPrefixListReferencesRequest): HttpRequestBuilder {
        ...
        val payload = serializeGetTransitGatewayPrefixListReferencesOperationBody(context, input)
...
private fun serializeGetTransitGatewayPrefixListReferencesOperationBody(context: ExecutionContext, input: GetTransitGatewayPrefixListReferencesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("GetTransitGatewayPrefixListReferencesRequest"))
        trait(QueryLiteral("Action", "GetTransitGatewayPrefixListReferences"))
