...
internal fun serializeScheduledInstancesBlockDeviceMappingDocument(serializer: Serializer, input: ScheduledInstancesBlockDeviceMapping) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("ScheduledInstancesBlockDeviceMapping"))
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.ebs?.let { field(EBS_DESCRIPTOR, it, ::serializeScheduledInstancesEbsDocument) }
