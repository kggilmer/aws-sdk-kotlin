 ...
 */
class TransitGatewayRouteAttachment private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): TransitGatewayRouteAttachment = BuilderImpl().apply(block).build()

    }

    override fun toString(): kotlin.String = buildString {
        append("TransitGatewayRouteAttachment(")
    ...
    override fun equals(other: kotlin.Any?): kotlin.Boolean {
        ...
        other as TransitGatewayRouteAttachment
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): TransitGatewayRouteAttachment = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): TransitGatewayRouteAttachment
        /**
         * The ID of the resource.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: TransitGatewayRouteAttachment) : this() {
            this.resourceId = x.resourceId
            this.resourceType = x.resourceType
            this.transitGatewayAttachmentId = x.transitGatewayAttachmentId
        }

        override fun build(): TransitGatewayRouteAttachment = TransitGatewayRouteAttachment(this)
