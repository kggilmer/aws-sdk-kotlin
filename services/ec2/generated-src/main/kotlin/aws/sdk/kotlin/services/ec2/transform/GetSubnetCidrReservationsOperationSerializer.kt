...
internal class GetSubnetCidrReservationsOperationSerializer: HttpSerialize<GetSubnetCidrReservationsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetSubnetCidrReservationsRequest): HttpRequestBuilder {
        ...
        val payload = serializeGetSubnetCidrReservationsOperationBody(context, input)
...
private fun serializeGetSubnetCidrReservationsOperationBody(context: ExecutionContext, input: GetSubnetCidrReservationsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("GetSubnetCidrReservationsRequest"))
        trait(QueryLiteral("Action", "GetSubnetCidrReservations"))
