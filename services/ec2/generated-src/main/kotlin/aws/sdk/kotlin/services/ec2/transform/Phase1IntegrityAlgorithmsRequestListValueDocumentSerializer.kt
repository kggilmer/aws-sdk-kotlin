...
internal fun serializePhase1IntegrityAlgorithmsRequestListValueDocument(serializer: Serializer, input: Phase1IntegrityAlgorithmsRequestListValue) {
    val VALUE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, FormUrlSerialName("Value"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("Phase1IntegrityAlgorithmsRequestListValue"))
