...
internal suspend fun deserializeInstanceNetworkInterfaceSpecificationDocument(deserializer: Deserializer): InstanceNetworkInterfaceSpecification {
    val builder = InstanceNetworkInterfaceSpecification.builder()
    ...
    val GROUPS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, XmlSerialName("SecurityGroupId"), XmlCollectionName("SecurityGroupId"))
    ...
    val IPV4PREFIXES_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, XmlSerialName("Ipv4Prefix"), XmlCollectionName("item"))
    ...
    val IPV6PREFIXES_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, XmlSerialName("Ipv6Prefix"), XmlCollectionName("item"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("InstanceNetworkInterfaceSpecification"))
            ...
            when (findNextFieldIndex()) {
                ...
                IPV4PREFIXES_DESCRIPTOR.index -> builder.ipv4Prefixes =
                    deserializer.deserializeList(IPV4PREFIXES_DESCRIPTOR) {
                        val col0 = mutableListOf<Ipv4PrefixSpecificationRequest>()
                        while (hasNextElement()) {
                            val el0 = if (nextHasValue()) { deserializeIpv4PrefixSpecificationRequestDocument(deserializer) } else { deserializeNull(); continue }
                            col0.add(el0)
                        }
                        col0
                    }
                ...
                IPV6PREFIXES_DESCRIPTOR.index -> builder.ipv6Prefixes =
                    deserializer.deserializeList(IPV6PREFIXES_DESCRIPTOR) {
                        val col0 = mutableListOf<Ipv6PrefixSpecificationRequest>()
                        while (hasNextElement()) {
                            val el0 = if (nextHasValue()) { deserializeIpv6PrefixSpecificationRequestDocument(deserializer) } else { deserializeNull(); continue }
                            col0.add(el0)
                        }
                        col0
                    }
