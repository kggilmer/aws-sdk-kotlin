...
internal class DescribePrefixListsOperationSerializer: HttpSerialize<DescribePrefixListsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribePrefixListsRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribePrefixListsOperationBody(context, input)
...
private fun serializeDescribePrefixListsOperationBody(context: ExecutionContext, input: DescribePrefixListsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribePrefixListsRequest"))
        trait(QueryLiteral("Action", "DescribePrefixLists"))
