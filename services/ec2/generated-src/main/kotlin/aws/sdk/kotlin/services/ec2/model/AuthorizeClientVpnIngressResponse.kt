...
class AuthorizeClientVpnIngressResponse private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): AuthorizeClientVpnIngressResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): AuthorizeClientVpnIngressResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): AuthorizeClientVpnIngressResponse
        /**
         * The current state of the authorization rule.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: AuthorizeClientVpnIngressResponse) : this() {
            this.status = x.status
        }

        override fun build(): AuthorizeClientVpnIngressResponse = AuthorizeClientVpnIngressResponse(this)
