...
internal suspend fun deserializeInstanceBlockDeviceMappingDocument(deserializer: Deserializer): InstanceBlockDeviceMapping {
    val builder = InstanceBlockDeviceMapping.builder()
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("InstanceBlockDeviceMapping"))
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                ...
                EBS_DESCRIPTOR.index -> builder.ebs = deserializeEbsInstanceBlockDeviceDocument(deserializer)
                null -> break@loop
                else -> skipValue()
            }
        }
