...
internal class DescribeClientVpnAuthorizationRulesOperationSerializer: HttpSerialize<DescribeClientVpnAuthorizationRulesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeClientVpnAuthorizationRulesRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeClientVpnAuthorizationRulesOperationBody(context, input)
...
private fun serializeDescribeClientVpnAuthorizationRulesOperationBody(context: ExecutionContext, input: DescribeClientVpnAuthorizationRulesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeClientVpnAuthorizationRulesRequest"))
        trait(QueryLiteral("Action", "DescribeClientVpnAuthorizationRules"))
