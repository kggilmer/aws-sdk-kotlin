...
internal class RevokeSecurityGroupIngressOperationSerializer: HttpSerialize<RevokeSecurityGroupIngressRequest> {
    override suspend fun serialize(context: ExecutionContext, input: RevokeSecurityGroupIngressRequest): HttpRequestBuilder {
        ...
        val payload = serializeRevokeSecurityGroupIngressOperationBody(context, input)
...
private fun serializeRevokeSecurityGroupIngressOperationBody(context: ExecutionContext, input: RevokeSecurityGroupIngressRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("RevokeSecurityGroupIngressRequest"))
        trait(QueryLiteral("Action", "RevokeSecurityGroupIngress"))
