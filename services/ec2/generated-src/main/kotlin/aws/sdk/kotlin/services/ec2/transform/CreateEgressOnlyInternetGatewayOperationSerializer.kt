...
internal class CreateEgressOnlyInternetGatewayOperationSerializer: HttpSerialize<CreateEgressOnlyInternetGatewayRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateEgressOnlyInternetGatewayRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateEgressOnlyInternetGatewayOperationBody(context, input)
...
private fun serializeCreateEgressOnlyInternetGatewayOperationBody(context: ExecutionContext, input: CreateEgressOnlyInternetGatewayRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateEgressOnlyInternetGatewayRequest"))
        trait(QueryLiteral("Action", "CreateEgressOnlyInternetGateway"))
