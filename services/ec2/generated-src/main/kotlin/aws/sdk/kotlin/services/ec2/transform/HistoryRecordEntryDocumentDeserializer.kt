...
internal suspend fun deserializeHistoryRecordEntryDocument(deserializer: Deserializer): HistoryRecordEntry {
    val builder = HistoryRecordEntry.builder()
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("HistoryRecordEntry"))
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                ...
                EVENTTYPE_DESCRIPTOR.index -> builder.eventType = deserializeString().let { FleetEventType.fromValue(it) }
