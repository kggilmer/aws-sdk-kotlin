...
internal class DescribeVpcEndpointConnectionsOperationSerializer: HttpSerialize<DescribeVpcEndpointConnectionsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeVpcEndpointConnectionsRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeVpcEndpointConnectionsOperationBody(context, input)
...
private fun serializeDescribeVpcEndpointConnectionsOperationBody(context: ExecutionContext, input: DescribeVpcEndpointConnectionsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeVpcEndpointConnectionsRequest"))
        trait(QueryLiteral("Action", "DescribeVpcEndpointConnections"))
