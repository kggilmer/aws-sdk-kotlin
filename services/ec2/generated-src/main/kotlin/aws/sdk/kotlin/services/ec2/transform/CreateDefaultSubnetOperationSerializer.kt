...
internal class CreateDefaultSubnetOperationSerializer: HttpSerialize<CreateDefaultSubnetRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateDefaultSubnetRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateDefaultSubnetOperationBody(context, input)
