...
internal suspend fun deserializeLocalGatewayRouteTableDocument(deserializer: Deserializer): LocalGatewayRouteTable {
    val builder = LocalGatewayRouteTable.builder()
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("LocalGatewayRouteTable"))
