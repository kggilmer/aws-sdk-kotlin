...
class DeleteTransitGatewayMulticastDomainRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): DeleteTransitGatewayMulticastDomainRequest = BuilderImpl().apply(block).build()

    }

    override fun toString(): kotlin.String = buildString {
        append("DeleteTransitGatewayMulticastDomainRequest(")
    ...
    override fun equals(other: kotlin.Any?): kotlin.Boolean {
        ...
        other as DeleteTransitGatewayMulticastDomainRequest
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): DeleteTransitGatewayMulticastDomainRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): DeleteTransitGatewayMulticastDomainRequest
        /**
         * Checks whether you have the required permissions for the action, without actually making the request,
         * and provides an error response. If you have the required permissions, the error response is DryRunOperation.
         * Otherwise, it is UnauthorizedOperation.
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: DeleteTransitGatewayMulticastDomainRequest) : this() {
            this.dryRun = x.dryRun
            this.transitGatewayMulticastDomainId = x.transitGatewayMulticastDomainId
        }

        override fun build(): DeleteTransitGatewayMulticastDomainRequest = DeleteTransitGatewayMulticastDomainRequest(this)
