...
class ModifyManagedPrefixListResponse private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): ModifyManagedPrefixListResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): ModifyManagedPrefixListResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): ModifyManagedPrefixListResponse
        /**
         * Information about the prefix list.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: ModifyManagedPrefixListResponse) : this() {
            this.prefixList = x.prefixList
        }

        override fun build(): ModifyManagedPrefixListResponse = ModifyManagedPrefixListResponse(this)
