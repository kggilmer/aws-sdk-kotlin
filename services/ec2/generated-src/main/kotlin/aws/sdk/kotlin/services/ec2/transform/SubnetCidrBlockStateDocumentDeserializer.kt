...
import aws.sdk.kotlin.services.ec2.model.SubnetCidrBlockState
import aws.sdk.kotlin.services.ec2.model.SubnetCidrBlockStateCode
...
internal suspend fun deserializeSubnetCidrBlockStateDocument(deserializer: Deserializer): SubnetCidrBlockState {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("SubnetCidrBlockState"))
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                STATE_DESCRIPTOR.index -> builder.state = deserializeString().let { SubnetCidrBlockStateCode.fromValue(it) }
