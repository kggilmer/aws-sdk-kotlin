 ...
 */
class CpuOptions private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): CpuOptions = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): CpuOptions = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): CpuOptions
        /**
         * The number of CPU cores for the instance.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: CpuOptions) : this() {
            this.coreCount = x.coreCount
            this.threadsPerCore = x.threadsPerCore
        }

        override fun build(): CpuOptions = CpuOptions(this)
