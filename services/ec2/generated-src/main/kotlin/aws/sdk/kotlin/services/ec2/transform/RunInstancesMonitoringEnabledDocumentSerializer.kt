...
internal fun serializeRunInstancesMonitoringEnabledDocument(serializer: Serializer, input: RunInstancesMonitoringEnabled) {
    val ENABLED_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Boolean, FormUrlSerialName("Enabled"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("RunInstancesMonitoringEnabled"))
