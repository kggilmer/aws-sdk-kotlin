...
internal class DescribeVpcEndpointServicePermissionsOperationSerializer: HttpSerialize<DescribeVpcEndpointServicePermissionsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeVpcEndpointServicePermissionsRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeVpcEndpointServicePermissionsOperationBody(context, input)
...
private fun serializeDescribeVpcEndpointServicePermissionsOperationBody(context: ExecutionContext, input: DescribeVpcEndpointServicePermissionsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeVpcEndpointServicePermissionsRequest"))
        trait(QueryLiteral("Action", "DescribeVpcEndpointServicePermissions"))
