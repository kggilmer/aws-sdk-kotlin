...
internal class SearchTransitGatewayRoutesOperationSerializer: HttpSerialize<SearchTransitGatewayRoutesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: SearchTransitGatewayRoutesRequest): HttpRequestBuilder {
        ...
        val payload = serializeSearchTransitGatewayRoutesOperationBody(context, input)
...
private fun serializeSearchTransitGatewayRoutesOperationBody(context: ExecutionContext, input: SearchTransitGatewayRoutesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("SearchTransitGatewayRoutesRequest"))
        trait(QueryLiteral("Action", "SearchTransitGatewayRoutes"))
