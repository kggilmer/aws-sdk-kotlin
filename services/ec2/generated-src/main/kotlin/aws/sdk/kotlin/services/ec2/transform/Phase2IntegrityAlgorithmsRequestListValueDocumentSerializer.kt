...
internal fun serializePhase2IntegrityAlgorithmsRequestListValueDocument(serializer: Serializer, input: Phase2IntegrityAlgorithmsRequestListValue) {
    val VALUE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, FormUrlSerialName("Value"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("Phase2IntegrityAlgorithmsRequestListValue"))
