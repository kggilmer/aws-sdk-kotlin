...
import aws.sdk.kotlin.services.ec2.model.TransitGatewayMulitcastDomainAssociationState
...
internal suspend fun deserializeSubnetAssociationDocument(deserializer: Deserializer): SubnetAssociation {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("SubnetAssociation"))
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                STATE_DESCRIPTOR.index -> builder.state = deserializeString().let { TransitGatewayMulitcastDomainAssociationState.fromValue(it) }
