...
internal class DescribeManagedPrefixListsOperationSerializer: HttpSerialize<DescribeManagedPrefixListsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeManagedPrefixListsRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeManagedPrefixListsOperationBody(context, input)
...
private fun serializeDescribeManagedPrefixListsOperationBody(context: ExecutionContext, input: DescribeManagedPrefixListsRequest): ByteArray {
    ...
    val PREFIXLISTIDS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, FormUrlSerialName("PrefixListId"), FormUrlFlattened)
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeManagedPrefixListsRequest"))
        trait(QueryLiteral("Action", "DescribeManagedPrefixLists"))
