 ...
 */
class LaunchSpecification private constructor(builder: BuilderImpl) {
    /**
     * Deprecated.
     */
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): LaunchSpecification = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): LaunchSpecification = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): LaunchSpecification
        /**
         * Deprecated.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: LaunchSpecification) : this() {
        ...
        override fun build(): LaunchSpecification = LaunchSpecification(this)
