...
class ModifyTransitGatewayPrefixListReferenceRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): ModifyTransitGatewayPrefixListReferenceRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): ModifyTransitGatewayPrefixListReferenceRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): ModifyTransitGatewayPrefixListReferenceRequest
        /**
         * Indicates whether to drop traffic that matches this route.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: ModifyTransitGatewayPrefixListReferenceRequest) : this() {
        ...
        override fun build(): ModifyTransitGatewayPrefixListReferenceRequest = ModifyTransitGatewayPrefixListReferenceRequest(this)
