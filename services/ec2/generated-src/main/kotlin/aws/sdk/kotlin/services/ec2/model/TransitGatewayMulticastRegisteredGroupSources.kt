 ...
 */
class TransitGatewayMulticastRegisteredGroupSources private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): TransitGatewayMulticastRegisteredGroupSources = BuilderImpl().apply(block).build()

    }

    override fun toString(): kotlin.String = buildString {
        append("TransitGatewayMulticastRegisteredGroupSources(")
    ...
    override fun equals(other: kotlin.Any?): kotlin.Boolean {
        ...
        other as TransitGatewayMulticastRegisteredGroupSources
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): TransitGatewayMulticastRegisteredGroupSources = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): TransitGatewayMulticastRegisteredGroupSources
        /**
         * The IP address assigned to the  transit gateway multicast group.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: TransitGatewayMulticastRegisteredGroupSources) : this() {
        ...
        override fun build(): TransitGatewayMulticastRegisteredGroupSources = TransitGatewayMulticastRegisteredGroupSources(this)
