...
internal fun serializeLoadPermissionModificationsDocument(serializer: Serializer, input: LoadPermissionModifications) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("LoadPermissionModifications"))
        ...
        if (input.add != null) {
            listField(ADD_DESCRIPTOR) {
                for (el0 in input.add) {
                    serializeSdkSerializable(asSdkSerializable(el0, ::serializeLoadPermissionRequestDocument))
                }
            }
        }
