...
internal suspend fun deserializeSpotInstanceStateFaultDocument(deserializer: Deserializer): SpotInstanceStateFault {
    val builder = SpotInstanceStateFault.builder()
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("SpotInstanceStateFault"))
