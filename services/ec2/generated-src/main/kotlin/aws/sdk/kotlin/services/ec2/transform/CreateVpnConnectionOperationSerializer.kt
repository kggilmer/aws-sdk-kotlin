...
internal class CreateVpnConnectionOperationSerializer: HttpSerialize<CreateVpnConnectionRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateVpnConnectionRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateVpnConnectionOperationBody(context, input)
...
private fun serializeCreateVpnConnectionOperationBody(context: ExecutionContext, input: CreateVpnConnectionRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateVpnConnectionRequest"))
        trait(QueryLiteral("Action", "CreateVpnConnection"))
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.options?.let { field(OPTIONS_DESCRIPTOR, it, ::serializeVpnConnectionOptionsSpecificationDocument) }
