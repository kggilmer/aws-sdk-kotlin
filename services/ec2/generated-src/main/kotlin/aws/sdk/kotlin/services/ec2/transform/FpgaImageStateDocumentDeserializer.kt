...
import aws.sdk.kotlin.services.ec2.model.FpgaImageStateCode
...
internal suspend fun deserializeFpgaImageStateDocument(deserializer: Deserializer): FpgaImageState {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("FpgaImageState"))
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                CODE_DESCRIPTOR.index -> builder.code = deserializeString().let { FpgaImageStateCode.fromValue(it) }
