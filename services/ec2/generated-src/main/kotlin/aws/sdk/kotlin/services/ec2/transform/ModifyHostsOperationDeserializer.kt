...
internal class ModifyHostsOperationDeserializer: HttpDeserialize<ModifyHostsResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): ModifyHostsResponse {
        if (!response.status.isSuccess()) {
            throwModifyHostsError(context, response)
        }
        val builder = ModifyHostsResponse.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeModifyHostsOperationBody(builder, payload)
        }
...
private suspend fun deserializeModifyHostsOperationBody(builder: ModifyHostsResponse.DslBuilder, payload: ByteArray) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        ...
        trait(XmlSerialName("ModifyHostsResult"))
...
private suspend fun throwModifyHostsError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
    val payload = response.body.readAll()
