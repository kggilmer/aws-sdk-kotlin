 ...
 */
class SpotOptions private constructor(builder: BuilderImpl) {
    /**
     ...
     */
    val maintenanceStrategies: FleetSpotMaintenanceStrategies? = builder.maintenanceStrategies
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): SpotOptions = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): SpotOptions = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): SpotOptions
        /**
         * Indicates how to allocate the target Spot Instance capacity across the Spot Instance pools specified by
         * the EC2 Fleet.
         * If the allocation strategy is lowest-price, EC2 Fleet launches instances from
         ...
         * interrupted. Currently only the capacity rebalance strategy is available.
         */
        fun maintenanceStrategies(maintenanceStrategies: FleetSpotMaintenanceStrategies): FluentBuilder
        /**
         * The maximum amount per hour for Spot Instances that you're willing to pay.
         */
    ...
    interface DslBuilder {
         ...
         * interrupted. Currently only the capacity rebalance strategy is available.
         */
        var maintenanceStrategies: FleetSpotMaintenanceStrategies?
        /**
         * The maximum amount per hour for Spot Instances that you're willing to pay.
         */
         ...
         */
        fun maintenanceStrategies(block: FleetSpotMaintenanceStrategies.DslBuilder.() -> kotlin.Unit) {
            this.maintenanceStrategies = FleetSpotMaintenanceStrategies.invoke(block)
        }
    }
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        override var maintenanceStrategies: FleetSpotMaintenanceStrategies? = null
        ...
        constructor(x: SpotOptions) : this() {
        ...
        override fun build(): SpotOptions = SpotOptions(this)
        ...
        override fun maintenanceStrategies(maintenanceStrategies: FleetSpotMaintenanceStrategies): FluentBuilder = apply { this.maintenanceStrategies = maintenanceStrategies }
