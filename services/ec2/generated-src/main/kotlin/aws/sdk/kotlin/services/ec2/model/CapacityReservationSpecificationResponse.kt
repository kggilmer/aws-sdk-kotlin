 ...
 */
class CapacityReservationSpecificationResponse private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): CapacityReservationSpecificationResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): CapacityReservationSpecificationResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): CapacityReservationSpecificationResponse
        /**
         * Describes the instance's Capacity Reservation preferences. Possible preferences include:
         * open - The instance can run in any open Capacity Reservation that
         * has matching attributes (instance type, platform, Availability Zone).
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: CapacityReservationSpecificationResponse) : this() {
        ...
        override fun build(): CapacityReservationSpecificationResponse = CapacityReservationSpecificationResponse(this)
