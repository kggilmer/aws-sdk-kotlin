...
internal class DescribeNetworkInterfacesOperationSerializer: HttpSerialize<DescribeNetworkInterfacesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeNetworkInterfacesRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeNetworkInterfacesOperationBody(context, input)
...
private fun serializeDescribeNetworkInterfacesOperationBody(context: ExecutionContext, input: DescribeNetworkInterfacesRequest): ByteArray {
    ...
    val NETWORKINTERFACEIDS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, FormUrlSerialName("NetworkInterfaceId"), FormUrlFlattened)
    val NEXTTOKEN_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, FormUrlSerialName("NextToken"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeNetworkInterfacesRequest"))
        trait(QueryLiteral("Action", "DescribeNetworkInterfaces"))
