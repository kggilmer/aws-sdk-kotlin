...
internal class GetTransitGatewayMulticastDomainAssociationsOperationSerializer: HttpSerialize<GetTransitGatewayMulticastDomainAssociationsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetTransitGatewayMulticastDomainAssociationsRequest): HttpRequestBuilder {
        ...
        val payload = serializeGetTransitGatewayMulticastDomainAssociationsOperationBody(context, input)
...
private fun serializeGetTransitGatewayMulticastDomainAssociationsOperationBody(context: ExecutionContext, input: GetTransitGatewayMulticastDomainAssociationsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("GetTransitGatewayMulticastDomainAssociationsRequest"))
        trait(QueryLiteral("Action", "GetTransitGatewayMulticastDomainAssociations"))
