 ...
 * Describes a volume.
 */
class CreateVolumeResponse private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): CreateVolumeResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): CreateVolumeResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): CreateVolumeResponse
        /**
         * Information about the volume attachments.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: CreateVolumeResponse) : this() {
        ...
        override fun build(): CreateVolumeResponse = CreateVolumeResponse(this)
