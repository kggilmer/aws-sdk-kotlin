...
class DescribeSnapshotAttributeRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): DescribeSnapshotAttributeRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): DescribeSnapshotAttributeRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): DescribeSnapshotAttributeRequest
        /**
         * The snapshot attribute you would like to view.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: DescribeSnapshotAttributeRequest) : this() {
            this.attribute = x.attribute
            this.dryRun = x.dryRun
            this.snapshotId = x.snapshotId
        }

        override fun build(): DescribeSnapshotAttributeRequest = DescribeSnapshotAttributeRequest(this)
