...
class AttachInternetGatewayRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): AttachInternetGatewayRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): AttachInternetGatewayRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): AttachInternetGatewayRequest
        /**
         * Checks whether you have the required permissions for the action, without actually making the request,
         * and provides an error response. If you have the required permissions, the error response is DryRunOperation.
         * Otherwise, it is UnauthorizedOperation.
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: AttachInternetGatewayRequest) : this() {
            this.dryRun = x.dryRun
            this.internetGatewayId = x.internetGatewayId
            this.vpcId = x.vpcId
        }

        override fun build(): AttachInternetGatewayRequest = AttachInternetGatewayRequest(this)
