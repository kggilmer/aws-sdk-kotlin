...
internal class DescribeLaunchTemplateVersionsOperationSerializer: HttpSerialize<DescribeLaunchTemplateVersionsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeLaunchTemplateVersionsRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeLaunchTemplateVersionsOperationBody(context, input)
...
private fun serializeDescribeLaunchTemplateVersionsOperationBody(context: ExecutionContext, input: DescribeLaunchTemplateVersionsRequest): ByteArray {
    ...
    val MAXVERSION_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, FormUrlSerialName("MaxVersion"))
    val MINVERSION_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, FormUrlSerialName("MinVersion"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeLaunchTemplateVersionsRequest"))
        trait(QueryLiteral("Action", "DescribeLaunchTemplateVersions"))
        ...
        field(MAXVERSION_DESCRIPTOR)
        field(MINVERSION_DESCRIPTOR)
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.maxVersion?.let { field(MAXVERSION_DESCRIPTOR, it) }
        input.minVersion?.let { field(MINVERSION_DESCRIPTOR, it) }
