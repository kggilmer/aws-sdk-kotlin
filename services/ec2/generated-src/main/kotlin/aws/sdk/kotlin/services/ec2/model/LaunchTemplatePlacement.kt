 ...
 */
class LaunchTemplatePlacement private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): LaunchTemplatePlacement = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): LaunchTemplatePlacement = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): LaunchTemplatePlacement
        /**
         * The affinity setting for the instance on the Dedicated Host.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: LaunchTemplatePlacement) : this() {
        ...
        override fun build(): LaunchTemplatePlacement = LaunchTemplatePlacement(this)
