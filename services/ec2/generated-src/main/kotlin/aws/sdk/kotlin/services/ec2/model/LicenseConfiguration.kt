 ...
 */
class LicenseConfiguration private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): LicenseConfiguration = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): LicenseConfiguration = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): LicenseConfiguration
        /**
         * The Amazon Resource Name (ARN) of the license configuration.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: LicenseConfiguration) : this() {
            this.licenseConfigurationArn = x.licenseConfigurationArn
        }

        override fun build(): LicenseConfiguration = LicenseConfiguration(this)
