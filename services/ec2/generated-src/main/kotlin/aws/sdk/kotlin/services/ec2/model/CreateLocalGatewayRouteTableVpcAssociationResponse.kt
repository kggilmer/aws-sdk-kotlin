...
class CreateLocalGatewayRouteTableVpcAssociationResponse private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): CreateLocalGatewayRouteTableVpcAssociationResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): CreateLocalGatewayRouteTableVpcAssociationResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): CreateLocalGatewayRouteTableVpcAssociationResponse
        /**
         * Information about the association.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: CreateLocalGatewayRouteTableVpcAssociationResponse) : this() {
            this.localGatewayRouteTableVpcAssociation = x.localGatewayRouteTableVpcAssociation
        }

        override fun build(): CreateLocalGatewayRouteTableVpcAssociationResponse = CreateLocalGatewayRouteTableVpcAssociationResponse(this)
