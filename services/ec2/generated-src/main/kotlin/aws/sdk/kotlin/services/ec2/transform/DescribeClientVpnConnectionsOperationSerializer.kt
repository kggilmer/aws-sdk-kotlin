...
internal class DescribeClientVpnConnectionsOperationSerializer: HttpSerialize<DescribeClientVpnConnectionsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeClientVpnConnectionsRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeClientVpnConnectionsOperationBody(context, input)
...
private fun serializeDescribeClientVpnConnectionsOperationBody(context: ExecutionContext, input: DescribeClientVpnConnectionsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeClientVpnConnectionsRequest"))
        trait(QueryLiteral("Action", "DescribeClientVpnConnections"))
