...
internal class CreateTransitGatewayOperationSerializer: HttpSerialize<CreateTransitGatewayRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateTransitGatewayRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateTransitGatewayOperationBody(context, input)
...
private fun serializeCreateTransitGatewayOperationBody(context: ExecutionContext, input: CreateTransitGatewayRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateTransitGatewayRequest"))
        trait(QueryLiteral("Action", "CreateTransitGateway"))
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.options?.let { field(OPTIONS_DESCRIPTOR, it, ::serializeTransitGatewayRequestOptionsDocument) }
