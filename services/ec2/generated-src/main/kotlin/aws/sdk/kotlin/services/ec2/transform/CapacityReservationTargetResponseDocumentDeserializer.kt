...
internal suspend fun deserializeCapacityReservationTargetResponseDocument(deserializer: Deserializer): CapacityReservationTargetResponse {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("CapacityReservationTargetResponse"))
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                ...
                CAPACITYRESERVATIONRESOURCEGROUPARN_DESCRIPTOR.index -> builder.capacityReservationResourceGroupArn = deserializeString()
                null -> break@loop
                else -> skipValue()
            }
        }
