 ...
 */
class CreateVpnConnectionRouteRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): CreateVpnConnectionRouteRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): CreateVpnConnectionRouteRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): CreateVpnConnectionRouteRequest
        /**
         * The CIDR block associated with the local subnet of the customer network.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: CreateVpnConnectionRouteRequest) : this() {
            this.destinationCidrBlock = x.destinationCidrBlock
            this.vpnConnectionId = x.vpnConnectionId
        }

        override fun build(): CreateVpnConnectionRouteRequest = CreateVpnConnectionRouteRequest(this)
