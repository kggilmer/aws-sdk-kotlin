...
internal class DescribeSpotFleetRequestHistoryOperationSerializer: HttpSerialize<DescribeSpotFleetRequestHistoryRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeSpotFleetRequestHistoryRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeSpotFleetRequestHistoryOperationBody(context, input)
...
private fun serializeDescribeSpotFleetRequestHistoryOperationBody(context: ExecutionContext, input: DescribeSpotFleetRequestHistoryRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeSpotFleetRequestHistoryRequest"))
        trait(QueryLiteral("Action", "DescribeSpotFleetRequestHistory"))
