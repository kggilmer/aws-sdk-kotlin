 ...
 */
class CreateTransitGatewayVpcAttachmentRequestOptions private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): CreateTransitGatewayVpcAttachmentRequestOptions = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): CreateTransitGatewayVpcAttachmentRequestOptions = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): CreateTransitGatewayVpcAttachmentRequestOptions
        /**
         * Enable or disable support for appliance mode. If enabled, a traffic flow between a source and destination uses the same Availability Zone for the VPC attachment for the lifetime of that flow. The default is disable.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: CreateTransitGatewayVpcAttachmentRequestOptions) : this() {
            this.applianceModeSupport = x.applianceModeSupport
            this.dnsSupport = x.dnsSupport
            this.ipv6Support = x.ipv6Support
        }

        override fun build(): CreateTransitGatewayVpcAttachmentRequestOptions = CreateTransitGatewayVpcAttachmentRequestOptions(this)
