...
import aws.sdk.kotlin.services.ec2.model.UnsuccessfulInstanceCreditSpecificationErrorCode
import aws.sdk.kotlin.services.ec2.model.UnsuccessfulInstanceCreditSpecificationItemError
...
internal suspend fun deserializeUnsuccessfulInstanceCreditSpecificationItemErrorDocument(deserializer: Deserializer): UnsuccessfulInstanceCreditSpecificationItemError {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("UnsuccessfulInstanceCreditSpecificationItemError"))
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                CODE_DESCRIPTOR.index -> builder.code = deserializeString().let { UnsuccessfulInstanceCreditSpecificationErrorCode.fromValue(it) }
