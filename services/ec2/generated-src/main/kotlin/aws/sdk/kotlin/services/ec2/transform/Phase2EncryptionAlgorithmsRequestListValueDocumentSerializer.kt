...
internal fun serializePhase2EncryptionAlgorithmsRequestListValueDocument(serializer: Serializer, input: Phase2EncryptionAlgorithmsRequestListValue) {
    val VALUE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, FormUrlSerialName("Value"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("Phase2EncryptionAlgorithmsRequestListValue"))
