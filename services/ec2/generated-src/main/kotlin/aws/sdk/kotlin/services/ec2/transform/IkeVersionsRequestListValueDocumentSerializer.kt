...
internal fun serializeIkeVersionsRequestListValueDocument(serializer: Serializer, input: IkeVersionsRequestListValue) {
    val VALUE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, FormUrlSerialName("Value"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("IkeVersionsRequestListValue"))
