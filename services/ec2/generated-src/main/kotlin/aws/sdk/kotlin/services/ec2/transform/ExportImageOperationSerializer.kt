...
internal class ExportImageOperationSerializer: HttpSerialize<ExportImageRequest> {
    override suspend fun serialize(context: ExecutionContext, input: ExportImageRequest): HttpRequestBuilder {
        ...
        val payload = serializeExportImageOperationBody(context, input)
...
private fun serializeExportImageOperationBody(context: ExecutionContext, input: ExportImageRequest): ByteArray {
    ...
    val S3EXPORTLOCATION_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Struct, FormUrlSerialName("S3ExportLocation"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("ExportImageRequest"))
        trait(QueryLiteral("Action", "ExportImage"))
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.s3ExportLocation?.let { field(S3EXPORTLOCATION_DESCRIPTOR, it, ::serializeExportTaskS3LocationRequestDocument) }
