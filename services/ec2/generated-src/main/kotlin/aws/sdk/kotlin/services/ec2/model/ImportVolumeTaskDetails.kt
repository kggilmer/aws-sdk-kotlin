 ...
 */
class ImportVolumeTaskDetails private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): ImportVolumeTaskDetails = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): ImportVolumeTaskDetails = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): ImportVolumeTaskDetails
        /**
         * The Availability Zone where the resulting volume will reside.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: ImportVolumeTaskDetails) : this() {
        ...
        override fun build(): ImportVolumeTaskDetails = ImportVolumeTaskDetails(this)
