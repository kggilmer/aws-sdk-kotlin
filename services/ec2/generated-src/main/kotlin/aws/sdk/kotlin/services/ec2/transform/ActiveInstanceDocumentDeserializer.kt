...
import aws.sdk.kotlin.services.ec2.model.InstanceHealthStatus
...
internal suspend fun deserializeActiveInstanceDocument(deserializer: Deserializer): ActiveInstance {
    val builder = ActiveInstance.builder()
    val INSTANCEHEALTH_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, XmlSerialName("instanceHealth"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("ActiveInstance"))
        trait(XmlNamespace("http://ec2.amazonaws.com/doc/2016-11-15"))
        field(INSTANCEHEALTH_DESCRIPTOR)
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                INSTANCEHEALTH_DESCRIPTOR.index -> builder.instanceHealth = deserializeString().let { InstanceHealthStatus.fromValue(it) }
