...
internal class DeleteNetworkInsightsAnalysisOperationDeserializer: HttpDeserialize<DeleteNetworkInsightsAnalysisResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): DeleteNetworkInsightsAnalysisResponse {
        if (!response.status.isSuccess()) {
            throwDeleteNetworkInsightsAnalysisError(context, response)
        }
        val builder = DeleteNetworkInsightsAnalysisResponse.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeDeleteNetworkInsightsAnalysisOperationBody(builder, payload)
        }
...
private suspend fun deserializeDeleteNetworkInsightsAnalysisOperationBody(builder: DeleteNetworkInsightsAnalysisResponse.DslBuilder, payload: ByteArray) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        ...
        trait(XmlSerialName("DeleteNetworkInsightsAnalysisResult"))
...
private suspend fun throwDeleteNetworkInsightsAnalysisError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
    val payload = response.body.readAll()
