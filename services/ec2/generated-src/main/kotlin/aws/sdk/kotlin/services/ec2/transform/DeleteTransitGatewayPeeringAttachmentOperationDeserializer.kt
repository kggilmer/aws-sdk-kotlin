...
internal class DeleteTransitGatewayPeeringAttachmentOperationDeserializer: HttpDeserialize<DeleteTransitGatewayPeeringAttachmentResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): DeleteTransitGatewayPeeringAttachmentResponse {
        if (!response.status.isSuccess()) {
            throwDeleteTransitGatewayPeeringAttachmentError(context, response)
        }
        val builder = DeleteTransitGatewayPeeringAttachmentResponse.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeDeleteTransitGatewayPeeringAttachmentOperationBody(builder, payload)
        }
...
private suspend fun deserializeDeleteTransitGatewayPeeringAttachmentOperationBody(builder: DeleteTransitGatewayPeeringAttachmentResponse.DslBuilder, payload: ByteArray) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        ...
        trait(XmlSerialName("DeleteTransitGatewayPeeringAttachmentResult"))
...
private suspend fun throwDeleteTransitGatewayPeeringAttachmentError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
    val payload = response.body.readAll()
