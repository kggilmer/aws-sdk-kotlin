...
internal fun serializeLicenseConfigurationRequestDocument(serializer: Serializer, input: LicenseConfigurationRequest) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("LicenseConfigurationRequest"))
