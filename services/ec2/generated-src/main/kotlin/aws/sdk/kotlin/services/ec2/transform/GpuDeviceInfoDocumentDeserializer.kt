...
internal suspend fun deserializeGpuDeviceInfoDocument(deserializer: Deserializer): GpuDeviceInfo {
    val builder = GpuDeviceInfo.builder()
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("GpuDeviceInfo"))
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                ...
                MEMORYINFO_DESCRIPTOR.index -> builder.memoryInfo = deserializeGpuDeviceMemoryInfoDocument(deserializer)
