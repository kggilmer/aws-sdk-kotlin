...
internal class DescribeInstanceStatusOperationSerializer: HttpSerialize<DescribeInstanceStatusRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeInstanceStatusRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeInstanceStatusOperationBody(context, input)
...
private fun serializeDescribeInstanceStatusOperationBody(context: ExecutionContext, input: DescribeInstanceStatusRequest): ByteArray {
    ...
    val INCLUDEALLINSTANCES_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Boolean, FormUrlSerialName("IncludeAllInstances"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeInstanceStatusRequest"))
        trait(QueryLiteral("Action", "DescribeInstanceStatus"))
        trait(QueryLiteral("Version", "2016-11-15"))
        field(DRYRUN_DESCRIPTOR)
        field(FILTERS_DESCRIPTOR)
        field(INCLUDEALLINSTANCES_DESCRIPTOR)
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.includeAllInstances?.let { field(INCLUDEALLINSTANCES_DESCRIPTOR, it) }
