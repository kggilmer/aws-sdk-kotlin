...
internal class GetTransitGatewayAttachmentPropagationsOperationSerializer: HttpSerialize<GetTransitGatewayAttachmentPropagationsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetTransitGatewayAttachmentPropagationsRequest): HttpRequestBuilder {
        ...
        val payload = serializeGetTransitGatewayAttachmentPropagationsOperationBody(context, input)
...
private fun serializeGetTransitGatewayAttachmentPropagationsOperationBody(context: ExecutionContext, input: GetTransitGatewayAttachmentPropagationsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("GetTransitGatewayAttachmentPropagationsRequest"))
        trait(QueryLiteral("Action", "GetTransitGatewayAttachmentPropagations"))
