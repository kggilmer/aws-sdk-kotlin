...
internal class DescribeVolumesModificationsOperationSerializer: HttpSerialize<DescribeVolumesModificationsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeVolumesModificationsRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeVolumesModificationsOperationBody(context, input)
