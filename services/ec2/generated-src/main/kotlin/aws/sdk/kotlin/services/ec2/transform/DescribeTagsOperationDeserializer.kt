...
internal class DescribeTagsOperationDeserializer: HttpDeserialize<DescribeTagsResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): DescribeTagsResponse {
        if (!response.status.isSuccess()) {
            throwDescribeTagsError(context, response)
        }
...
private suspend fun deserializeDescribeTagsOperationBody(builder: DescribeTagsResponse.DslBuilder, payload: ByteArray) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        ...
        trait(XmlSerialName("DescribeTagsResult"))
            ...
            when (findNextFieldIndex()) {
                ...
                TAGS_DESCRIPTOR.index -> builder.tags =
                    deserializer.deserializeList(TAGS_DESCRIPTOR) {
                        val col0 = mutableListOf<TagDescription>()
...
private suspend fun throwDescribeTagsError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
    val payload = response.body.readAll()
