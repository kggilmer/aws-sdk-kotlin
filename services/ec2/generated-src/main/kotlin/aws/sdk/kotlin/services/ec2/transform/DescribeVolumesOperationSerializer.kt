...
internal class DescribeVolumesOperationSerializer: HttpSerialize<DescribeVolumesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeVolumesRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeVolumesOperationBody(context, input)
...
private fun serializeDescribeVolumesOperationBody(context: ExecutionContext, input: DescribeVolumesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeVolumesRequest"))
        trait(QueryLiteral("Action", "DescribeVolumes"))
