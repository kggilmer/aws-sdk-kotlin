...
internal class DescribeVolumeStatusOperationSerializer: HttpSerialize<DescribeVolumeStatusRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeVolumeStatusRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeVolumeStatusOperationBody(context, input)
...
private fun serializeDescribeVolumeStatusOperationBody(context: ExecutionContext, input: DescribeVolumeStatusRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeVolumeStatusRequest"))
        trait(QueryLiteral("Action", "DescribeVolumeStatus"))
