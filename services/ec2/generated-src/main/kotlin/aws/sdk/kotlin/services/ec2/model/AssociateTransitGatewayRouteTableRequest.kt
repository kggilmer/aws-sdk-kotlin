...
class AssociateTransitGatewayRouteTableRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): AssociateTransitGatewayRouteTableRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): AssociateTransitGatewayRouteTableRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): AssociateTransitGatewayRouteTableRequest
        /**
         * Checks whether you have the required permissions for the action, without actually making the request,
         * and provides an error response. If you have the required permissions, the error response is DryRunOperation.
         * Otherwise, it is UnauthorizedOperation.
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: AssociateTransitGatewayRouteTableRequest) : this() {
        ...
        override fun build(): AssociateTransitGatewayRouteTableRequest = AssociateTransitGatewayRouteTableRequest(this)
