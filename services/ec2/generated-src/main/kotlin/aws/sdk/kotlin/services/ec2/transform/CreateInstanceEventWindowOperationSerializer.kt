...
internal class CreateInstanceEventWindowOperationSerializer: HttpSerialize<CreateInstanceEventWindowRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateInstanceEventWindowRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateInstanceEventWindowOperationBody(context, input)
...
private fun serializeCreateInstanceEventWindowOperationBody(context: ExecutionContext, input: CreateInstanceEventWindowRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateInstanceEventWindowRequest"))
        trait(QueryLiteral("Action", "CreateInstanceEventWindow"))
