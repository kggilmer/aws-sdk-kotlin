...
internal class CreateImageOperationSerializer: HttpSerialize<CreateImageRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateImageRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateImageOperationBody(context, input)
...
private fun serializeCreateImageOperationBody(context: ExecutionContext, input: CreateImageRequest): ByteArray {
    ...
    val NOREBOOT_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Boolean, FormUrlSerialName("NoReboot"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateImageRequest"))
        trait(QueryLiteral("Action", "CreateImage"))
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.noReboot?.let { field(NOREBOOT_DESCRIPTOR, it) }
