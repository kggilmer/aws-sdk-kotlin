...
internal suspend fun deserializeAddressAttributeDocument(deserializer: Deserializer): AddressAttribute {
    ...
    val PTRRECORDUPDATE_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Struct, XmlSerialName("ptrRecordUpdate"))
    val PUBLICIP_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, XmlSerialName("publicIp"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("AddressAttribute"))
        trait(XmlNamespace("http://ec2.amazonaws.com/doc/2016-11-15"))
        field(ALLOCATIONID_DESCRIPTOR)
        field(PTRRECORD_DESCRIPTOR)
        field(PTRRECORDUPDATE_DESCRIPTOR)
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                ...
                PTRRECORD_DESCRIPTOR.index -> builder.ptrRecord = deserializeString()
                PTRRECORDUPDATE_DESCRIPTOR.index -> builder.ptrRecordUpdate = deserializePtrUpdateStatusDocument(deserializer)
