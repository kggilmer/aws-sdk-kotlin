 ...
 */
class ExportTaskS3Location private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): ExportTaskS3Location = BuilderImpl().apply(block).build()

    }

    override fun toString(): kotlin.String = buildString {
        append("ExportTaskS3Location(")
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): ExportTaskS3Location = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): ExportTaskS3Location
        /**
         * The destination Amazon S3 bucket.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: ExportTaskS3Location) : this() {
            this.s3Bucket = x.s3Bucket
            this.s3Prefix = x.s3Prefix
        }

        override fun build(): ExportTaskS3Location = ExportTaskS3Location(this)
