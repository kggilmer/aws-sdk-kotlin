...
internal class SearchTransitGatewayMulticastGroupsOperationSerializer: HttpSerialize<SearchTransitGatewayMulticastGroupsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: SearchTransitGatewayMulticastGroupsRequest): HttpRequestBuilder {
        ...
        val payload = serializeSearchTransitGatewayMulticastGroupsOperationBody(context, input)
...
private fun serializeSearchTransitGatewayMulticastGroupsOperationBody(context: ExecutionContext, input: SearchTransitGatewayMulticastGroupsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("SearchTransitGatewayMulticastGroupsRequest"))
        trait(QueryLiteral("Action", "SearchTransitGatewayMulticastGroups"))
