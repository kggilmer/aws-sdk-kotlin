...
internal suspend fun deserializeFailedCapacityReservationFleetCancellationResultDocument(deserializer: Deserializer): FailedCapacityReservationFleetCancellationResult {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("FailedCapacityReservationFleetCancellationResult"))
        trait(XmlNamespace("http://ec2.amazonaws.com/doc/2016-11-15"))
        field(CANCELCAPACITYRESERVATIONFLEETERROR_DESCRIPTOR)
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                CANCELCAPACITYRESERVATIONFLEETERROR_DESCRIPTOR.index -> builder.cancelCapacityReservationFleetError = deserializeCancelCapacityReservationFleetErrorDocument(deserializer)
