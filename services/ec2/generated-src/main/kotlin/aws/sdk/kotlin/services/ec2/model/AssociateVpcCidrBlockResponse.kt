...
class AssociateVpcCidrBlockResponse private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): AssociateVpcCidrBlockResponse = BuilderImpl().apply(block).build()

    }

    override fun toString(): kotlin.String = buildString {
        append("AssociateVpcCidrBlockResponse(")
    ...
    override fun equals(other: kotlin.Any?): kotlin.Boolean {
        ...
        other as AssociateVpcCidrBlockResponse
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): AssociateVpcCidrBlockResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): AssociateVpcCidrBlockResponse
        /**
         * Information about the IPv4 CIDR block association.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: AssociateVpcCidrBlockResponse) : this() {
            this.cidrBlockAssociation = x.cidrBlockAssociation
            this.ipv6CidrBlockAssociation = x.ipv6CidrBlockAssociation
            this.vpcId = x.vpcId
        }

        override fun build(): AssociateVpcCidrBlockResponse = AssociateVpcCidrBlockResponse(this)
