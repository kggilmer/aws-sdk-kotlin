...
internal suspend fun deserializeEnableFastSnapshotRestoreStateErrorItemDocument(deserializer: Deserializer): EnableFastSnapshotRestoreStateErrorItem {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("EnableFastSnapshotRestoreStateErrorItem"))
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                ...
                ERROR_DESCRIPTOR.index -> builder.error = deserializeEnableFastSnapshotRestoreStateErrorDocument(deserializer)
                null -> break@loop
                else -> skipValue()
            }
        }
