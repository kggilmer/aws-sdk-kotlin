...
internal suspend fun deserializeNetworkAclAssociationDocument(deserializer: Deserializer): NetworkAclAssociation {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("NetworkAclAssociation"))
        trait(XmlNamespace("http://ec2.amazonaws.com/doc/2016-11-15"))
        field(NETWORKACLASSOCIATIONID_DESCRIPTOR)
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                NETWORKACLASSOCIATIONID_DESCRIPTOR.index -> builder.networkAclAssociationId = deserializeString()
