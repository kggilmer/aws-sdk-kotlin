...
internal class GetTransitGatewayRouteTablePropagationsOperationSerializer: HttpSerialize<GetTransitGatewayRouteTablePropagationsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetTransitGatewayRouteTablePropagationsRequest): HttpRequestBuilder {
        ...
        val payload = serializeGetTransitGatewayRouteTablePropagationsOperationBody(context, input)
...
private fun serializeGetTransitGatewayRouteTablePropagationsOperationBody(context: ExecutionContext, input: GetTransitGatewayRouteTablePropagationsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("GetTransitGatewayRouteTablePropagationsRequest"))
        trait(QueryLiteral("Action", "GetTransitGatewayRouteTablePropagations"))
