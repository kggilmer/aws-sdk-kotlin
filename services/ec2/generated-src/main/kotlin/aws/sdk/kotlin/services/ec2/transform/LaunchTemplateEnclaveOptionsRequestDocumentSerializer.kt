...
internal fun serializeLaunchTemplateEnclaveOptionsRequestDocument(serializer: Serializer, input: LaunchTemplateEnclaveOptionsRequest) {
    val ENABLED_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Boolean, FormUrlSerialName("Enabled"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("LaunchTemplateEnclaveOptionsRequest"))
