...
internal fun serializeElasticInferenceAcceleratorDocument(serializer: Serializer, input: ElasticInferenceAccelerator) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("ElasticInferenceAccelerator"))
