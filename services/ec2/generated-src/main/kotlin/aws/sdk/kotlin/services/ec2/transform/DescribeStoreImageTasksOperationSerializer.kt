...
internal class DescribeStoreImageTasksOperationSerializer: HttpSerialize<DescribeStoreImageTasksRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeStoreImageTasksRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeStoreImageTasksOperationBody(context, input)
...
private fun serializeDescribeStoreImageTasksOperationBody(context: ExecutionContext, input: DescribeStoreImageTasksRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeStoreImageTasksRequest"))
        trait(QueryLiteral("Action", "DescribeStoreImageTasks"))
