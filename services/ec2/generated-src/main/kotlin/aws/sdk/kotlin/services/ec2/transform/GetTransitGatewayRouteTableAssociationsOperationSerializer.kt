...
internal class GetTransitGatewayRouteTableAssociationsOperationSerializer: HttpSerialize<GetTransitGatewayRouteTableAssociationsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetTransitGatewayRouteTableAssociationsRequest): HttpRequestBuilder {
        ...
        val payload = serializeGetTransitGatewayRouteTableAssociationsOperationBody(context, input)
...
private fun serializeGetTransitGatewayRouteTableAssociationsOperationBody(context: ExecutionContext, input: GetTransitGatewayRouteTableAssociationsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("GetTransitGatewayRouteTableAssociationsRequest"))
        trait(QueryLiteral("Action", "GetTransitGatewayRouteTableAssociations"))
