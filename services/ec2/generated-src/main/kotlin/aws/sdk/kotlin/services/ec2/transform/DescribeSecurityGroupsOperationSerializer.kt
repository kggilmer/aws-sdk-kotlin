...
internal class DescribeSecurityGroupsOperationSerializer: HttpSerialize<DescribeSecurityGroupsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeSecurityGroupsRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeSecurityGroupsOperationBody(context, input)
...
private fun serializeDescribeSecurityGroupsOperationBody(context: ExecutionContext, input: DescribeSecurityGroupsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeSecurityGroupsRequest"))
        trait(QueryLiteral("Action", "DescribeSecurityGroups"))
