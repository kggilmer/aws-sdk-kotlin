 ...
 */
class DescribeFleetError private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): DescribeFleetError = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): DescribeFleetError = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): DescribeFleetError
        /**
         * The error code that indicates why the instance could not be launched. For more
         * information about error codes, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/errors-overview.html.html">Error Codes.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: DescribeFleetError) : this() {
        ...
        override fun build(): DescribeFleetError = DescribeFleetError(this)
