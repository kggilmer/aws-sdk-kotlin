...
internal fun serializeScheduledInstancesPlacementDocument(serializer: Serializer, input: ScheduledInstancesPlacement) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("ScheduledInstancesPlacement"))
