 ...
 */
class GroupIdentifier private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): GroupIdentifier = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): GroupIdentifier = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): GroupIdentifier
        /**
         * The ID of the security group.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: GroupIdentifier) : this() {
            this.groupId = x.groupId
            this.groupName = x.groupName
        }

        override fun build(): GroupIdentifier = GroupIdentifier(this)
