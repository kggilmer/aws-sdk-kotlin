...
internal class DescribePlacementGroupsOperationSerializer: HttpSerialize<DescribePlacementGroupsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribePlacementGroupsRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribePlacementGroupsOperationBody(context, input)
...
private fun serializeDescribePlacementGroupsOperationBody(context: ExecutionContext, input: DescribePlacementGroupsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribePlacementGroupsRequest"))
        trait(QueryLiteral("Action", "DescribePlacementGroups"))
