 ...
 */
class AcceptReservedInstancesExchangeQuoteRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): AcceptReservedInstancesExchangeQuoteRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): AcceptReservedInstancesExchangeQuoteRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): AcceptReservedInstancesExchangeQuoteRequest
        /**
         * Checks whether you have the required permissions for the action, without actually making the request,
         * and provides an error response. If you have the required permissions, the error response is DryRunOperation.
         * Otherwise, it is UnauthorizedOperation.
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: AcceptReservedInstancesExchangeQuoteRequest) : this() {
            this.dryRun = x.dryRun
            this.reservedInstanceIds = x.reservedInstanceIds
            this.targetConfigurations = x.targetConfigurations
        }

        override fun build(): AcceptReservedInstancesExchangeQuoteRequest = AcceptReservedInstancesExchangeQuoteRequest(this)
