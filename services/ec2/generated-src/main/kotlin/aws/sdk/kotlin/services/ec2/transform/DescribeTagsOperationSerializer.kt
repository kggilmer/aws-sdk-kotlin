...
internal class DescribeTagsOperationSerializer: HttpSerialize<DescribeTagsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeTagsRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeTagsOperationBody(context, input)
...
private fun serializeDescribeTagsOperationBody(context: ExecutionContext, input: DescribeTagsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeTagsRequest"))
        trait(QueryLiteral("Action", "DescribeTags"))
