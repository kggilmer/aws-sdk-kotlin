...
internal fun serializeInstanceBlockDeviceMappingSpecificationDocument(serializer: Serializer, input: InstanceBlockDeviceMappingSpecification) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("InstanceBlockDeviceMappingSpecification"))
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.ebs?.let { field(EBS_DESCRIPTOR, it, ::serializeEbsInstanceBlockDeviceSpecificationDocument) }
