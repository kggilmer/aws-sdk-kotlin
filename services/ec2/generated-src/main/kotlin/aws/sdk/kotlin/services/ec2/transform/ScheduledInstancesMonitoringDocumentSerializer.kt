...
internal fun serializeScheduledInstancesMonitoringDocument(serializer: Serializer, input: ScheduledInstancesMonitoring) {
    val ENABLED_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Boolean, FormUrlSerialName("Enabled"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("ScheduledInstancesMonitoring"))
