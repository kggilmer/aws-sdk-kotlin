...
internal class DescribeRouteTablesOperationSerializer: HttpSerialize<DescribeRouteTablesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeRouteTablesRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeRouteTablesOperationBody(context, input)
...
private fun serializeDescribeRouteTablesOperationBody(context: ExecutionContext, input: DescribeRouteTablesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeRouteTablesRequest"))
        trait(QueryLiteral("Action", "DescribeRouteTables"))
