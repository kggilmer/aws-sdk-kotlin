...
internal class CreateCarrierGatewayOperationSerializer: HttpSerialize<CreateCarrierGatewayRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateCarrierGatewayRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateCarrierGatewayOperationBody(context, input)
...
private fun serializeCreateCarrierGatewayOperationBody(context: ExecutionContext, input: CreateCarrierGatewayRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateCarrierGatewayRequest"))
        trait(QueryLiteral("Action", "CreateCarrierGateway"))
