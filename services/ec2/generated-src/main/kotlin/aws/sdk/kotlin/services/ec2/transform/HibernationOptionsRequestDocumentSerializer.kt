...
internal fun serializeHibernationOptionsRequestDocument(serializer: Serializer, input: HibernationOptionsRequest) {
    val CONFIGURED_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Boolean, FormUrlSerialName("Configured"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("HibernationOptionsRequest"))
