...
internal class CreateNetworkAclEntryOperationSerializer: HttpSerialize<CreateNetworkAclEntryRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateNetworkAclEntryRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateNetworkAclEntryOperationBody(context, input)
...
private fun serializeCreateNetworkAclEntryOperationBody(context: ExecutionContext, input: CreateNetworkAclEntryRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateNetworkAclEntryRequest"))
        trait(QueryLiteral("Action", "CreateNetworkAclEntry"))
