...
internal class GetCoipPoolUsageOperationSerializer: HttpSerialize<GetCoipPoolUsageRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetCoipPoolUsageRequest): HttpRequestBuilder {
        ...
        val payload = serializeGetCoipPoolUsageOperationBody(context, input)
...
private fun serializeGetCoipPoolUsageOperationBody(context: ExecutionContext, input: GetCoipPoolUsageRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("GetCoipPoolUsageRequest"))
        trait(QueryLiteral("Action", "GetCoipPoolUsage"))
