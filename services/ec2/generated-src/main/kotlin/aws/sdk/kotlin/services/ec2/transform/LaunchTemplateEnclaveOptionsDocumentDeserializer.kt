...
internal suspend fun deserializeLaunchTemplateEnclaveOptionsDocument(deserializer: Deserializer): LaunchTemplateEnclaveOptions {
    val builder = LaunchTemplateEnclaveOptions.builder()
    val ENABLED_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Boolean, XmlSerialName("enabled"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("LaunchTemplateEnclaveOptions"))
