...
internal class DescribeFastSnapshotRestoresOperationSerializer: HttpSerialize<DescribeFastSnapshotRestoresRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeFastSnapshotRestoresRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeFastSnapshotRestoresOperationBody(context, input)
...
private fun serializeDescribeFastSnapshotRestoresOperationBody(context: ExecutionContext, input: DescribeFastSnapshotRestoresRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeFastSnapshotRestoresRequest"))
        trait(QueryLiteral("Action", "DescribeFastSnapshotRestores"))
