...
class GetTransitGatewayRouteTableAssociationsRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): GetTransitGatewayRouteTableAssociationsRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): GetTransitGatewayRouteTableAssociationsRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): GetTransitGatewayRouteTableAssociationsRequest
        /**
         * Checks whether you have the required permissions for the action, without actually making the request,
         * and provides an error response. If you have the required permissions, the error response is DryRunOperation.
         * Otherwise, it is UnauthorizedOperation.
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: GetTransitGatewayRouteTableAssociationsRequest) : this() {
        ...
        override fun build(): GetTransitGatewayRouteTableAssociationsRequest = GetTransitGatewayRouteTableAssociationsRequest(this)
