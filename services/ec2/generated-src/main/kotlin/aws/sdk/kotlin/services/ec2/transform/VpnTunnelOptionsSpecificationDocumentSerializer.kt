...
internal fun serializeVpnTunnelOptionsSpecificationDocument(serializer: Serializer, input: VpnTunnelOptionsSpecification) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("VpnTunnelOptionsSpecification"))
