 ...
 */
class FpgaDeviceInfo private constructor(builder: BuilderImpl) {
    /**
     ...
     */
    val memoryInfo: FpgaDeviceMemoryInfo? = builder.memoryInfo
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): FpgaDeviceInfo = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): FpgaDeviceInfo = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): FpgaDeviceInfo
        /**
         * The count of FPGA accelerators for the instance type.
         */
         ...
         * Describes the memory for the FPGA accelerator for the instance type.
         */
        fun memoryInfo(memoryInfo: FpgaDeviceMemoryInfo): FluentBuilder
        /**
         * The name of the FPGA accelerator.
         */
    ...
    interface DslBuilder {
         ...
         */
        fun memoryInfo(block: FpgaDeviceMemoryInfo.DslBuilder.() -> kotlin.Unit) {
            this.memoryInfo = FpgaDeviceMemoryInfo.invoke(block)
        }
    }
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        override var memoryInfo: FpgaDeviceMemoryInfo? = null
        override var name: String? = null

        constructor(x: FpgaDeviceInfo) : this() {
            this.count = x.count
        ...
        override fun build(): FpgaDeviceInfo = FpgaDeviceInfo(this)
        ...
        override fun memoryInfo(memoryInfo: FpgaDeviceMemoryInfo): FluentBuilder = apply { this.memoryInfo = memoryInfo }
