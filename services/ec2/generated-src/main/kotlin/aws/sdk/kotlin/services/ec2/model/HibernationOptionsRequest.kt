 ...
 */
class HibernationOptionsRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): HibernationOptionsRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): HibernationOptionsRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): HibernationOptionsRequest
        /**
         * If you set this parameter to true, your instance is enabled for
         * hibernation.
         * Default: false
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: HibernationOptionsRequest) : this() {
            this.configured = x.configured
        }

        override fun build(): HibernationOptionsRequest = HibernationOptionsRequest(this)
