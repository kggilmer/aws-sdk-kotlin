...
internal class DescribeClassicLinkInstancesOperationSerializer: HttpSerialize<DescribeClassicLinkInstancesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeClassicLinkInstancesRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeClassicLinkInstancesOperationBody(context, input)
...
private fun serializeDescribeClassicLinkInstancesOperationBody(context: ExecutionContext, input: DescribeClassicLinkInstancesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeClassicLinkInstancesRequest"))
        trait(QueryLiteral("Action", "DescribeClassicLinkInstances"))
