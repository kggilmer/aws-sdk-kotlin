...
import aws.sdk.kotlin.services.ec2.model.DeleteQueuedReservedInstancesError
import aws.sdk.kotlin.services.ec2.model.DeleteQueuedReservedInstancesErrorCode
...
internal suspend fun deserializeDeleteQueuedReservedInstancesErrorDocument(deserializer: Deserializer): DeleteQueuedReservedInstancesError {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("DeleteQueuedReservedInstancesError"))
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                CODE_DESCRIPTOR.index -> builder.code = deserializeString().let { DeleteQueuedReservedInstancesErrorCode.fromValue(it) }
