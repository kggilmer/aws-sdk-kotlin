...
internal class CreateTransitGatewayVpcAttachmentOperationSerializer: HttpSerialize<CreateTransitGatewayVpcAttachmentRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateTransitGatewayVpcAttachmentRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateTransitGatewayVpcAttachmentOperationBody(context, input)
...
private fun serializeCreateTransitGatewayVpcAttachmentOperationBody(context: ExecutionContext, input: CreateTransitGatewayVpcAttachmentRequest): ByteArray {
    val serializer = FormUrlSerializer()
    val DRYRUN_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Boolean, FormUrlSerialName("DryRun"))
    val OPTIONS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Struct, FormUrlSerialName("Options"))
    val SUBNETIDS_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, FormUrlSerialName("SubnetIds"), FormUrlFlattened)
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateTransitGatewayVpcAttachmentRequest"))
        trait(QueryLiteral("Action", "CreateTransitGatewayVpcAttachment"))
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.options?.let { field(OPTIONS_DESCRIPTOR, it, ::serializeCreateTransitGatewayVpcAttachmentRequestOptionsDocument) }
