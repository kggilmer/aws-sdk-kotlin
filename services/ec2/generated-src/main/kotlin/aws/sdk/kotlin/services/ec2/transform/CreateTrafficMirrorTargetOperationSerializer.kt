...
internal class CreateTrafficMirrorTargetOperationSerializer: HttpSerialize<CreateTrafficMirrorTargetRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateTrafficMirrorTargetRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateTrafficMirrorTargetOperationBody(context, input)
...
private fun serializeCreateTrafficMirrorTargetOperationBody(context: ExecutionContext, input: CreateTrafficMirrorTargetRequest): ByteArray {
    ...
    val NETWORKLOADBALANCERARN_DESCRIPTOR = SdkFieldDescriptor(SerialKind.String, FormUrlSerialName("NetworkLoadBalancerArn"))
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateTrafficMirrorTargetRequest"))
        trait(QueryLiteral("Action", "CreateTrafficMirrorTarget"))
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        ...
        input.networkLoadBalancerArn?.let { field(NETWORKLOADBALANCERARN_DESCRIPTOR, it) }
