...
internal suspend fun deserializeStateReasonDocument(deserializer: Deserializer): StateReason {
    val builder = StateReason.builder()
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("StateReason"))
