...
internal class AttachVolumeOperationDeserializer: HttpDeserialize<AttachVolumeResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): AttachVolumeResponse {
        if (!response.status.isSuccess()) {
            throwAttachVolumeError(context, response)
        }
        val builder = AttachVolumeResponse.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeAttachVolumeOperationBody(builder, payload)
        }
...
private suspend fun deserializeAttachVolumeOperationBody(builder: AttachVolumeResponse.DslBuilder, payload: ByteArray) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        ...
        trait(XmlSerialName("AttachVolumeResult"))
...
private suspend fun throwAttachVolumeError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
    val payload = response.body.readAll()
