...
internal fun serializeFleetLaunchTemplateSpecificationRequestDocument(serializer: Serializer, input: FleetLaunchTemplateSpecificationRequest) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("FleetLaunchTemplateSpecificationRequest"))
