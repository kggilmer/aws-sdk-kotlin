...
internal class DescribeInstancesOperationSerializer: HttpSerialize<DescribeInstancesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeInstancesRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeInstancesOperationBody(context, input)
...
private fun serializeDescribeInstancesOperationBody(context: ExecutionContext, input: DescribeInstancesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeInstancesRequest"))
        trait(QueryLiteral("Action", "DescribeInstances"))
