...
internal class DescribeSubnetsOperationSerializer: HttpSerialize<DescribeSubnetsRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeSubnetsRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeSubnetsOperationBody(context, input)
...
private fun serializeDescribeSubnetsOperationBody(context: ExecutionContext, input: DescribeSubnetsRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeSubnetsRequest"))
        trait(QueryLiteral("Action", "DescribeSubnets"))
