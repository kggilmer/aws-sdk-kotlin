...
class AssociateClientVpnTargetNetworkResponse private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): AssociateClientVpnTargetNetworkResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): AssociateClientVpnTargetNetworkResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): AssociateClientVpnTargetNetworkResponse
        /**
         * The unique ID of the target network association.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: AssociateClientVpnTargetNetworkResponse) : this() {
            this.associationId = x.associationId
            this.status = x.status
        }

        override fun build(): AssociateClientVpnTargetNetworkResponse = AssociateClientVpnTargetNetworkResponse(this)
