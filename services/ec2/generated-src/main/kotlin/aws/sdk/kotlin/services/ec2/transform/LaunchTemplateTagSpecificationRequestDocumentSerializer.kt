...
internal fun serializeLaunchTemplateTagSpecificationRequestDocument(serializer: Serializer, input: LaunchTemplateTagSpecificationRequest) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("LaunchTemplateTagSpecificationRequest"))
