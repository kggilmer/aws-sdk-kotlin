...
internal class AcceptReservedInstancesExchangeQuoteOperationSerializer: HttpSerialize<AcceptReservedInstancesExchangeQuoteRequest> {
    override suspend fun serialize(context: ExecutionContext, input: AcceptReservedInstancesExchangeQuoteRequest): HttpRequestBuilder {
        ...
        val payload = serializeAcceptReservedInstancesExchangeQuoteOperationBody(context, input)
...
private fun serializeAcceptReservedInstancesExchangeQuoteOperationBody(context: ExecutionContext, input: AcceptReservedInstancesExchangeQuoteRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("AcceptReservedInstancesExchangeQuoteRequest"))
        trait(QueryLiteral("Action", "AcceptReservedInstancesExchangeQuote"))
