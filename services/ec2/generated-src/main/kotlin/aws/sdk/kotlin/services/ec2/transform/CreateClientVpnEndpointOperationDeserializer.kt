...
internal class CreateClientVpnEndpointOperationDeserializer: HttpDeserialize<CreateClientVpnEndpointResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): CreateClientVpnEndpointResponse {
        if (!response.status.isSuccess()) {
            throwCreateClientVpnEndpointError(context, response)
        }
        val builder = CreateClientVpnEndpointResponse.builder()

        val payload = response.body.readAll()
        if (payload != null) {
            deserializeCreateClientVpnEndpointOperationBody(builder, payload)
        }
...
private suspend fun deserializeCreateClientVpnEndpointOperationBody(builder: CreateClientVpnEndpointResponse.DslBuilder, payload: ByteArray) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        ...
        trait(XmlSerialName("CreateClientVpnEndpointResult"))
...
private suspend fun throwCreateClientVpnEndpointError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
    val payload = response.body.readAll()
