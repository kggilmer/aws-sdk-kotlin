...
internal fun serializeRequestSpotLaunchSpecificationDocument(serializer: Serializer, input: RequestSpotLaunchSpecification) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("RequestSpotLaunchSpecification"))
