...
internal class DescribeFleetInstancesOperationSerializer: HttpSerialize<DescribeFleetInstancesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: DescribeFleetInstancesRequest): HttpRequestBuilder {
        ...
        val payload = serializeDescribeFleetInstancesOperationBody(context, input)
...
private fun serializeDescribeFleetInstancesOperationBody(context: ExecutionContext, input: DescribeFleetInstancesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("DescribeFleetInstancesRequest"))
        trait(QueryLiteral("Action", "DescribeFleetInstances"))
