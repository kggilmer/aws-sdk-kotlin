...
class DisassociateTransitGatewayMulticastDomainRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): DisassociateTransitGatewayMulticastDomainRequest = BuilderImpl().apply(block).build()

    }

    override fun toString(): kotlin.String = buildString {
        append("DisassociateTransitGatewayMulticastDomainRequest(")
    ...
    override fun equals(other: kotlin.Any?): kotlin.Boolean {
        ...
        other as DisassociateTransitGatewayMulticastDomainRequest
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): DisassociateTransitGatewayMulticastDomainRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): DisassociateTransitGatewayMulticastDomainRequest
        /**
         * Checks whether you have the required permissions for the action, without actually making the request,
         * and provides an error response. If you have the required permissions, the error response is DryRunOperation.
         * Otherwise, it is UnauthorizedOperation.
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: DisassociateTransitGatewayMulticastDomainRequest) : this() {
        ...
        override fun build(): DisassociateTransitGatewayMulticastDomainRequest = DisassociateTransitGatewayMulticastDomainRequest(this)
