 ...
 */
class LaunchTemplateInstanceMetadataOptionsRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): LaunchTemplateInstanceMetadataOptionsRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): LaunchTemplateInstanceMetadataOptionsRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): LaunchTemplateInstanceMetadataOptionsRequest
        /**
         * This parameter enables or disables the HTTP metadata endpoint on your instances. If the parameter is not specified, the default state is enabled.
         * If you specify a value of disabled, you will not be able to access your instance metadata.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: LaunchTemplateInstanceMetadataOptionsRequest) : this() {
        ...
        override fun build(): LaunchTemplateInstanceMetadataOptionsRequest = LaunchTemplateInstanceMetadataOptionsRequest(this)
