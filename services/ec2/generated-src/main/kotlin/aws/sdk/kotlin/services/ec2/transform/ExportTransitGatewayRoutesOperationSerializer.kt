...
internal class ExportTransitGatewayRoutesOperationSerializer: HttpSerialize<ExportTransitGatewayRoutesRequest> {
    override suspend fun serialize(context: ExecutionContext, input: ExportTransitGatewayRoutesRequest): HttpRequestBuilder {
        ...
        val payload = serializeExportTransitGatewayRoutesOperationBody(context, input)
...
private fun serializeExportTransitGatewayRoutesOperationBody(context: ExecutionContext, input: ExportTransitGatewayRoutesRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("ExportTransitGatewayRoutesRequest"))
        trait(QueryLiteral("Action", "ExportTransitGatewayRoutes"))
