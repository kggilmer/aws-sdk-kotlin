...
class EnableSerialConsoleAccessResponse private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): EnableSerialConsoleAccessResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): EnableSerialConsoleAccessResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): EnableSerialConsoleAccessResponse
        /**
         * If true, access to the EC2 serial console of all instances is enabled for
         * your account. If false, access to the EC2 serial console of all instances
         * is disabled for your account.
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: EnableSerialConsoleAccessResponse) : this() {
            this.serialConsoleAccessEnabled = x.serialConsoleAccessEnabled
        }

        override fun build(): EnableSerialConsoleAccessResponse = EnableSerialConsoleAccessResponse(this)
