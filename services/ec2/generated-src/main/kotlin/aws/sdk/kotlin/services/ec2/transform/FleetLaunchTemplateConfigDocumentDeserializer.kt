...
internal suspend fun deserializeFleetLaunchTemplateConfigDocument(deserializer: Deserializer): FleetLaunchTemplateConfig {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("FleetLaunchTemplateConfig"))
            ...
            when (findNextFieldIndex()) {
                ...
                OVERRIDES_DESCRIPTOR.index -> builder.overrides =
                    deserializer.deserializeList(OVERRIDES_DESCRIPTOR) {
                        val col0 = mutableListOf<FleetLaunchTemplateOverrides>()
                        while (hasNextElement()) {
                            val el0 = if (nextHasValue()) { deserializeFleetLaunchTemplateOverridesDocument(deserializer) } else { deserializeNull(); continue }
                            col0.add(el0)
                        }
                        col0
                    }
