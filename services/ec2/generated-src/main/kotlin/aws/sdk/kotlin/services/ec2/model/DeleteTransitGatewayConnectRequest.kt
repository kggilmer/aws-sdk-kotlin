...
class DeleteTransitGatewayConnectRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): DeleteTransitGatewayConnectRequest = BuilderImpl().apply(block).build()

    }

    override fun toString(): kotlin.String = buildString {
        append("DeleteTransitGatewayConnectRequest(")
    ...
    override fun equals(other: kotlin.Any?): kotlin.Boolean {
        ...
        other as DeleteTransitGatewayConnectRequest
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): DeleteTransitGatewayConnectRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): DeleteTransitGatewayConnectRequest
        /**
         * Checks whether you have the required permissions for the action, without actually making the request,
         * and provides an error response. If you have the required permissions, the error response is DryRunOperation.
         * Otherwise, it is UnauthorizedOperation.
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: DeleteTransitGatewayConnectRequest) : this() {
            this.dryRun = x.dryRun
            this.transitGatewayAttachmentId = x.transitGatewayAttachmentId
        }

        override fun build(): DeleteTransitGatewayConnectRequest = DeleteTransitGatewayConnectRequest(this)
