...
internal class CreateRouteTableOperationSerializer: HttpSerialize<CreateRouteTableRequest> {
    override suspend fun serialize(context: ExecutionContext, input: CreateRouteTableRequest): HttpRequestBuilder {
        ...
        val payload = serializeCreateRouteTableOperationBody(context, input)
...
private fun serializeCreateRouteTableOperationBody(context: ExecutionContext, input: CreateRouteTableRequest): ByteArray {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(FormUrlSerialName("CreateRouteTableRequest"))
        trait(QueryLiteral("Action", "CreateRouteTable"))
