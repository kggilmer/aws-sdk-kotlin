 ...
 */
class CreateFleetInstance private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): CreateFleetInstance = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): CreateFleetInstance = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): CreateFleetInstance
        /**
         * The IDs of the instances.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: CreateFleetInstance) : this() {
        ...
        override fun build(): CreateFleetInstance = CreateFleetInstance(this)
