 ...
 */
class LaunchTemplateLicenseConfiguration private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): LaunchTemplateLicenseConfiguration = BuilderImpl().apply(block).build()

    }

    override fun toString(): kotlin.String = buildString {
        append("LaunchTemplateLicenseConfiguration(")
    ...
    override fun equals(other: kotlin.Any?): kotlin.Boolean {
        ...
        other as LaunchTemplateLicenseConfiguration
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): LaunchTemplateLicenseConfiguration = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): LaunchTemplateLicenseConfiguration
        /**
         * The Amazon Resource Name (ARN) of the license configuration.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: LaunchTemplateLicenseConfiguration) : this() {
            this.licenseConfigurationArn = x.licenseConfigurationArn
        }

        override fun build(): LaunchTemplateLicenseConfiguration = LaunchTemplateLicenseConfiguration(this)
