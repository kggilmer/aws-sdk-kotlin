...
internal class PutBucketOwnershipControlsOperationDeserializer: HttpDeserialize<PutBucketOwnershipControlsResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutBucketOwnershipControlsResponse {
        if (!response.status.isSuccess()) {
            throwPutBucketOwnershipControlsError(context, response)
        }
        val builder = PutBucketOwnershipControlsResponse.builder()

        return builder.build()
    }
}

private suspend fun throwPutBucketOwnershipControlsError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
