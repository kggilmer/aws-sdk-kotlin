...
internal class PutBucketVersioningOperationDeserializer: HttpDeserialize<PutBucketVersioningResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutBucketVersioningResponse {
        if (!response.status.isSuccess()) {
            throwPutBucketVersioningError(context, response)
        }
        val builder = PutBucketVersioningResponse.builder()

        return builder.build()
    }
}

private suspend fun throwPutBucketVersioningError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
