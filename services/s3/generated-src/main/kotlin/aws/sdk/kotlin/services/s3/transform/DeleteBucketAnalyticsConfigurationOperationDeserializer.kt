...
internal class DeleteBucketAnalyticsConfigurationOperationDeserializer: HttpDeserialize<DeleteBucketAnalyticsConfigurationResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): DeleteBucketAnalyticsConfigurationResponse {
        if (!response.status.isSuccess()) {
            throwDeleteBucketAnalyticsConfigurationError(context, response)
        }
        val builder = DeleteBucketAnalyticsConfigurationResponse.builder()

        return builder.build()
    }
}

private suspend fun throwDeleteBucketAnalyticsConfigurationError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
