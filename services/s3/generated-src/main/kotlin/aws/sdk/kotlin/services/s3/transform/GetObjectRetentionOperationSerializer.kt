...
internal class GetObjectRetentionOperationSerializer: HttpSerialize<GetObjectRetentionRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetObjectRetentionRequest): HttpRequestBuilder {
