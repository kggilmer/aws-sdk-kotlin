...
internal class PutBucketEncryptionOperationDeserializer: HttpDeserialize<PutBucketEncryptionResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutBucketEncryptionResponse {
        if (!response.status.isSuccess()) {
            throwPutBucketEncryptionError(context, response)
        }
        val builder = PutBucketEncryptionResponse.builder()

        return builder.build()
    }
}

private suspend fun throwPutBucketEncryptionError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
