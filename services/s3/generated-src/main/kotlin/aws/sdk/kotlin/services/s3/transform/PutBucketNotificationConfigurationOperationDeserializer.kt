...
internal class PutBucketNotificationConfigurationOperationDeserializer: HttpDeserialize<PutBucketNotificationConfigurationResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutBucketNotificationConfigurationResponse {
        if (!response.status.isSuccess()) {
            throwPutBucketNotificationConfigurationError(context, response)
        }
        val builder = PutBucketNotificationConfigurationResponse.builder()

        return builder.build()
    }
}

private suspend fun throwPutBucketNotificationConfigurationError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
