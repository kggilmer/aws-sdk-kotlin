...
internal fun serializeReplicationRuleAndOperatorDocument(serializer: Serializer, input: ReplicationRuleAndOperator) {
    ...
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("ReplicationRuleAndOperator"))
