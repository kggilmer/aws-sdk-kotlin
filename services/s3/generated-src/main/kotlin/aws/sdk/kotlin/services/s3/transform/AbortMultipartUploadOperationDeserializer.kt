...
internal class AbortMultipartUploadOperationDeserializer: HttpDeserialize<AbortMultipartUploadResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): AbortMultipartUploadResponse {
        if (!response.status.isSuccess()) {
            throwAbortMultipartUploadError(context, response)
        }
        val builder = AbortMultipartUploadResponse.builder()
...
private suspend fun throwAbortMultipartUploadError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
    ...
    val modeledExceptionDeserializer = when(errorDetails.code) {
        "NoSuchUpload" -> NoSuchUploadDeserializer()
