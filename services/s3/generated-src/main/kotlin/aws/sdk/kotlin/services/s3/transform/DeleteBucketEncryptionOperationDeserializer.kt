...
internal class DeleteBucketEncryptionOperationDeserializer: HttpDeserialize<DeleteBucketEncryptionResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): DeleteBucketEncryptionResponse {
        if (!response.status.isSuccess()) {
            throwDeleteBucketEncryptionError(context, response)
        }
        val builder = DeleteBucketEncryptionResponse.builder()

        return builder.build()
    }
}

private suspend fun throwDeleteBucketEncryptionError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
