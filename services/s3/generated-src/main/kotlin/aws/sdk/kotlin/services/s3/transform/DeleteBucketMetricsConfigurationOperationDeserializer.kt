...
internal class DeleteBucketMetricsConfigurationOperationDeserializer: HttpDeserialize<DeleteBucketMetricsConfigurationResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): DeleteBucketMetricsConfigurationResponse {
        if (!response.status.isSuccess()) {
            throwDeleteBucketMetricsConfigurationError(context, response)
        }
        val builder = DeleteBucketMetricsConfigurationResponse.builder()

        return builder.build()
    }
}

private suspend fun throwDeleteBucketMetricsConfigurationError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
