...
class GetBucketMetricsConfigurationRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): GetBucketMetricsConfigurationRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): GetBucketMetricsConfigurationRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): GetBucketMetricsConfigurationRequest
        /**
         * The name of the bucket containing the metrics configuration to retrieve.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: GetBucketMetricsConfigurationRequest) : this() {
            this.bucket = x.bucket
            this.expectedBucketOwner = x.expectedBucketOwner
            this.id = x.id
        }

        override fun build(): GetBucketMetricsConfigurationRequest = GetBucketMetricsConfigurationRequest(this)
