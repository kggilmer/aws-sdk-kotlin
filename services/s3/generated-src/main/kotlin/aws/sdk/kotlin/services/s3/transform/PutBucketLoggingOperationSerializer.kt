...
internal class PutBucketLoggingOperationSerializer: HttpSerialize<PutBucketLoggingRequest> {
    override suspend fun serialize(context: ExecutionContext, input: PutBucketLoggingRequest): HttpRequestBuilder {
        ...
        if (input.bucketLoggingStatus != null) {
            val payload = serializePutBucketLoggingOperationBody(context, input)
...
private fun serializePutBucketLoggingOperationBody(context: ExecutionContext, input: PutBucketLoggingRequest): ByteArray {
    val serializer = XmlSerializer()
    val input = requireNotNull(input.bucketLoggingStatus)
