...
internal class PutBucketRequestPaymentOperationDeserializer: HttpDeserialize<PutBucketRequestPaymentResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutBucketRequestPaymentResponse {
        if (!response.status.isSuccess()) {
            throwPutBucketRequestPaymentError(context, response)
        }
        val builder = PutBucketRequestPaymentResponse.builder()

        return builder.build()
    }
}

private suspend fun throwPutBucketRequestPaymentError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
