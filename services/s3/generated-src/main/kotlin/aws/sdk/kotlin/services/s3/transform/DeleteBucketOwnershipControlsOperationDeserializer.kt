...
internal class DeleteBucketOwnershipControlsOperationDeserializer: HttpDeserialize<DeleteBucketOwnershipControlsResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): DeleteBucketOwnershipControlsResponse {
        if (!response.status.isSuccess()) {
            throwDeleteBucketOwnershipControlsError(context, response)
        }
        val builder = DeleteBucketOwnershipControlsResponse.builder()

        return builder.build()
    }
}

private suspend fun throwDeleteBucketOwnershipControlsError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
