...
internal fun serializeBucketLifecycleConfigurationDocument(serializer: Serializer, input: BucketLifecycleConfiguration) {
    val RULES_DESCRIPTOR = SdkFieldDescriptor(SerialKind.List, XmlSerialName("Rule"), Flattened)
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        trait(XmlSerialName("BucketLifecycleConfiguration"))
