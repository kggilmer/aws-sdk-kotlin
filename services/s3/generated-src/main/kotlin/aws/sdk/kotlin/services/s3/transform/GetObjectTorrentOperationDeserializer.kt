...
internal class GetObjectTorrentOperationDeserializer: HttpDeserialize<GetObjectTorrentResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): GetObjectTorrentResponse {
        if (!response.status.isSuccess()) {
            throwGetObjectTorrentError(context, response)
        }
        val builder = GetObjectTorrentResponse.builder()
...
private suspend fun throwGetObjectTorrentError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
