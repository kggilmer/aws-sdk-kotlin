...
class GetBucketAclResponse private constructor(builder: BuilderImpl) {
    /**
     * A list of grants.
     */
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): GetBucketAclResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): GetBucketAclResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): GetBucketAclResponse
        /**
         * A list of grants.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: GetBucketAclResponse) : this() {
            this.grants = x.grants
            this.owner = x.owner
        }

        override fun build(): GetBucketAclResponse = GetBucketAclResponse(this)
