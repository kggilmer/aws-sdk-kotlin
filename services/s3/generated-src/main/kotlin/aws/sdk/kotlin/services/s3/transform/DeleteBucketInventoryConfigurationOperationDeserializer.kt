...
internal class DeleteBucketInventoryConfigurationOperationDeserializer: HttpDeserialize<DeleteBucketInventoryConfigurationResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): DeleteBucketInventoryConfigurationResponse {
        if (!response.status.isSuccess()) {
            throwDeleteBucketInventoryConfigurationError(context, response)
        }
        val builder = DeleteBucketInventoryConfigurationResponse.builder()

        return builder.build()
    }
}

private suspend fun throwDeleteBucketInventoryConfigurationError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
