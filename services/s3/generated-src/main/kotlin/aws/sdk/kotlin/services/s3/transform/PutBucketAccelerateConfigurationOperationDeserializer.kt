...
internal class PutBucketAccelerateConfigurationOperationDeserializer: HttpDeserialize<PutBucketAccelerateConfigurationResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutBucketAccelerateConfigurationResponse {
        if (!response.status.isSuccess()) {
            throwPutBucketAccelerateConfigurationError(context, response)
        }
        val builder = PutBucketAccelerateConfigurationResponse.builder()

        return builder.build()
    }
}

private suspend fun throwPutBucketAccelerateConfigurationError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
