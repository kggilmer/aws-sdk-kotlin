...
class DeleteBucketRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): DeleteBucketRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): DeleteBucketRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): DeleteBucketRequest
        /**
         * Specifies the bucket being deleted.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: DeleteBucketRequest) : this() {
            this.bucket = x.bucket
            this.expectedBucketOwner = x.expectedBucketOwner
        }

        override fun build(): DeleteBucketRequest = DeleteBucketRequest(this)
