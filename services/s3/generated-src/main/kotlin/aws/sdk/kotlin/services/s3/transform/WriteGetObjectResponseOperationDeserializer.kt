...
internal class WriteGetObjectResponseOperationDeserializer: HttpDeserialize<WriteGetObjectResponseResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): WriteGetObjectResponseResponse {
        if (!response.status.isSuccess()) {
            throwWriteGetObjectResponseError(context, response)
        }
        val builder = WriteGetObjectResponseResponse.builder()

        return builder.build()
    }
}

private suspend fun throwWriteGetObjectResponseError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
