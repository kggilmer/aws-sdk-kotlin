...
class GetBucketPolicyRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): GetBucketPolicyRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): GetBucketPolicyRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): GetBucketPolicyRequest
        /**
         * The bucket name for which to get the bucket policy.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: GetBucketPolicyRequest) : this() {
            this.bucket = x.bucket
            this.expectedBucketOwner = x.expectedBucketOwner
        }

        override fun build(): GetBucketPolicyRequest = GetBucketPolicyRequest(this)
