...
internal class PutBucketIntelligentTieringConfigurationOperationDeserializer: HttpDeserialize<PutBucketIntelligentTieringConfigurationResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutBucketIntelligentTieringConfigurationResponse {
        if (!response.status.isSuccess()) {
            throwPutBucketIntelligentTieringConfigurationError(context, response)
        }
        val builder = PutBucketIntelligentTieringConfigurationResponse.builder()

        return builder.build()
    }
}

private suspend fun throwPutBucketIntelligentTieringConfigurationError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
