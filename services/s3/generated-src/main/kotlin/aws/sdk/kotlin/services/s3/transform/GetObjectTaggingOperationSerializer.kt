...
internal class GetObjectTaggingOperationSerializer: HttpSerialize<GetObjectTaggingRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetObjectTaggingRequest): HttpRequestBuilder {
