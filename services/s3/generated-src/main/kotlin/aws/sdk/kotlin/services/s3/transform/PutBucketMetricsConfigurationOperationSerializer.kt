...
internal class PutBucketMetricsConfigurationOperationSerializer: HttpSerialize<PutBucketMetricsConfigurationRequest> {
    override suspend fun serialize(context: ExecutionContext, input: PutBucketMetricsConfigurationRequest): HttpRequestBuilder {
        ...
        if (input.metricsConfiguration != null) {
            val payload = serializePutBucketMetricsConfigurationOperationBody(context, input)
...
private fun serializePutBucketMetricsConfigurationOperationBody(context: ExecutionContext, input: PutBucketMetricsConfigurationRequest): ByteArray {
    val serializer = XmlSerializer()
    val input = requireNotNull(input.metricsConfiguration)
