...
class GetBucketReplicationRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): GetBucketReplicationRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): GetBucketReplicationRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): GetBucketReplicationRequest
        /**
         * The bucket name for which to get the replication information.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: GetBucketReplicationRequest) : this() {
            this.bucket = x.bucket
            this.expectedBucketOwner = x.expectedBucketOwner
        }

        override fun build(): GetBucketReplicationRequest = GetBucketReplicationRequest(this)
