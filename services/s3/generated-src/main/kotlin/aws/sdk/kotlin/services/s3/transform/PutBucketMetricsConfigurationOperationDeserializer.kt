...
internal class PutBucketMetricsConfigurationOperationDeserializer: HttpDeserialize<PutBucketMetricsConfigurationResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutBucketMetricsConfigurationResponse {
        if (!response.status.isSuccess()) {
            throwPutBucketMetricsConfigurationError(context, response)
        }
        val builder = PutBucketMetricsConfigurationResponse.builder()

        return builder.build()
    }
}

private suspend fun throwPutBucketMetricsConfigurationError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
