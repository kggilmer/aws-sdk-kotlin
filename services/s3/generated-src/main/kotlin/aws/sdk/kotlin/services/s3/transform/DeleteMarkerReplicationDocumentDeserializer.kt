...
import aws.sdk.kotlin.services.s3.model.DeleteMarkerReplicationStatus
    ...
    deserializer.deserializeStruct(OBJ_DESCRIPTOR) {
        loop@while (true) {
            when (findNextFieldIndex()) {
                STATUS_DESCRIPTOR.index -> builder.status = deserializeString().let { DeleteMarkerReplicationStatus.fromValue(it) }
                null -> break@loop
                else -> skipValue()
            }
        }
