...
internal class PutBucketAnalyticsConfigurationOperationDeserializer: HttpDeserialize<PutBucketAnalyticsConfigurationResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutBucketAnalyticsConfigurationResponse {
        if (!response.status.isSuccess()) {
            throwPutBucketAnalyticsConfigurationError(context, response)
        }
        val builder = PutBucketAnalyticsConfigurationResponse.builder()

        return builder.build()
    }
}

private suspend fun throwPutBucketAnalyticsConfigurationError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
