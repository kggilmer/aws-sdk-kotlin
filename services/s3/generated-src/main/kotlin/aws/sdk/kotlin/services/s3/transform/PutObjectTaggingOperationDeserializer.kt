...
internal class PutObjectTaggingOperationDeserializer: HttpDeserialize<PutObjectTaggingResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutObjectTaggingResponse {
        if (!response.status.isSuccess()) {
            throwPutObjectTaggingError(context, response)
        }
        val builder = PutObjectTaggingResponse.builder()
...
private suspend fun throwPutObjectTaggingError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
