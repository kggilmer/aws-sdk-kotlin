...
internal suspend fun deserializeMetricsFilterDocument(deserializer: Deserializer): MetricsFilter {
    ...
    return value ?: throw DeserializationException("Deserialized value unexpectedly null: MetricsFilter")
}
