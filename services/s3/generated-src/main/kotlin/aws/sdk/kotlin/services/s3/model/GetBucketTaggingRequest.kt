...
class GetBucketTaggingRequest private constructor(builder: BuilderImpl) {
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): GetBucketTaggingRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): GetBucketTaggingRequest = BuilderImpl(this).apply(block).build()
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: GetBucketTaggingRequest) : this() {
