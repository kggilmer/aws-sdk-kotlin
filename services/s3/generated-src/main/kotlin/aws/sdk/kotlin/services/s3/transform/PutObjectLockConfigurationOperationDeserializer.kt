...
internal class PutObjectLockConfigurationOperationDeserializer: HttpDeserialize<PutObjectLockConfigurationResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutObjectLockConfigurationResponse {
        if (!response.status.isSuccess()) {
            throwPutObjectLockConfigurationError(context, response)
        }
        val builder = PutObjectLockConfigurationResponse.builder()
...
private suspend fun throwPutObjectLockConfigurationError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
