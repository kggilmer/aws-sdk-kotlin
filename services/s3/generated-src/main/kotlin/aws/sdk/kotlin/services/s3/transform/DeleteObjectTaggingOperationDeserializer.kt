...
internal class DeleteObjectTaggingOperationDeserializer: HttpDeserialize<DeleteObjectTaggingResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): DeleteObjectTaggingResponse {
        if (!response.status.isSuccess()) {
            throwDeleteObjectTaggingError(context, response)
        }
        val builder = DeleteObjectTaggingResponse.builder()
...
private suspend fun throwDeleteObjectTaggingError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
