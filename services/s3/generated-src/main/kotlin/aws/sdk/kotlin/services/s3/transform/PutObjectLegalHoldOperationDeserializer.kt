...
internal class PutObjectLegalHoldOperationDeserializer: HttpDeserialize<PutObjectLegalHoldResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutObjectLegalHoldResponse {
        if (!response.status.isSuccess()) {
            throwPutObjectLegalHoldError(context, response)
        }
        val builder = PutObjectLegalHoldResponse.builder()
...
private suspend fun throwPutObjectLegalHoldError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
