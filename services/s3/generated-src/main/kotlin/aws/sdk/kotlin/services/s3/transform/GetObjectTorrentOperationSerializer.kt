...
internal class GetObjectTorrentOperationSerializer: HttpSerialize<GetObjectTorrentRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetObjectTorrentRequest): HttpRequestBuilder {
