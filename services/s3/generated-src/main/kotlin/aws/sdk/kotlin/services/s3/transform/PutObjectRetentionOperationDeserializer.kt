...
internal class PutObjectRetentionOperationDeserializer: HttpDeserialize<PutObjectRetentionResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutObjectRetentionResponse {
        if (!response.status.isSuccess()) {
            throwPutObjectRetentionError(context, response)
        }
        val builder = PutObjectRetentionResponse.builder()
...
private suspend fun throwPutObjectRetentionError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
