...
internal class DeletePublicAccessBlockOperationDeserializer: HttpDeserialize<DeletePublicAccessBlockResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): DeletePublicAccessBlockResponse {
        if (!response.status.isSuccess()) {
            throwDeletePublicAccessBlockError(context, response)
        }
        val builder = DeletePublicAccessBlockResponse.builder()

        return builder.build()
    }
}

private suspend fun throwDeletePublicAccessBlockError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
