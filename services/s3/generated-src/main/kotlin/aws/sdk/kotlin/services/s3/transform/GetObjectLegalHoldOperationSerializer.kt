...
internal class GetObjectLegalHoldOperationSerializer: HttpSerialize<GetObjectLegalHoldRequest> {
    override suspend fun serialize(context: ExecutionContext, input: GetObjectLegalHoldRequest): HttpRequestBuilder {
