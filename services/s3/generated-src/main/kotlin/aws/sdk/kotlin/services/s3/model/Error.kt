 ...
 */
class Error private constructor(builder: BuilderImpl) {
    /**
     ...
     * following URL: <a href="http://aws.amazon.com/s3">Amazon S3
     * HTTP Status Code: 403 Forbidden
     * SOAP Fault Code Prefix: Client
     ...
     * signing method. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/RESTAuthentication.html">REST Authentication and
     * <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/SOAPAuthentication.html">SOAP Authentication
     * for details.
     * HTTP Status Code: 403 Forbidden
     * SOAP Fault Code Prefix: Client
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): Error = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): Error = BuilderImpl(this).apply(block).build()
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        override fun build(): Error = Error(this)
