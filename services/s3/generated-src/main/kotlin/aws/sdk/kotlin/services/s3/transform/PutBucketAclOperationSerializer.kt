...
internal class PutBucketAclOperationSerializer: HttpSerialize<PutBucketAclRequest> {
    override suspend fun serialize(context: ExecutionContext, input: PutBucketAclRequest): HttpRequestBuilder {
        ...
        if (input.accessControlPolicy != null) {
            val payload = serializePutBucketAclOperationBody(context, input)
...
private fun serializePutBucketAclOperationBody(context: ExecutionContext, input: PutBucketAclRequest): ByteArray {
