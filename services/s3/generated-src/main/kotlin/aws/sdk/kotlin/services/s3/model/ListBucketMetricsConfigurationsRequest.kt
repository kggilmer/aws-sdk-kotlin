...
class ListBucketMetricsConfigurationsRequest private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): ListBucketMetricsConfigurationsRequest = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): ListBucketMetricsConfigurationsRequest = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): ListBucketMetricsConfigurationsRequest
        /**
         * The name of the bucket containing the metrics configurations to retrieve.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: ListBucketMetricsConfigurationsRequest) : this() {
            this.bucket = x.bucket
            this.continuationToken = x.continuationToken
            this.expectedBucketOwner = x.expectedBucketOwner
        }

        override fun build(): ListBucketMetricsConfigurationsRequest = ListBucketMetricsConfigurationsRequest(this)
