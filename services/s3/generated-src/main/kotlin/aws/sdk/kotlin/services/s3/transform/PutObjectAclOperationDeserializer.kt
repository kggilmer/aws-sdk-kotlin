...
internal class PutObjectAclOperationDeserializer: HttpDeserialize<PutObjectAclResponse> {

    override suspend fun deserialize(context: ExecutionContext, response: HttpResponse): PutObjectAclResponse {
        if (!response.status.isSuccess()) {
            throwPutObjectAclError(context, response)
        }
        val builder = PutObjectAclResponse.builder()
...
private suspend fun throwPutObjectAclError(context: ExecutionContext, response: HttpResponse): kotlin.Nothing {
