...
internal fun serializeAnalyticsExportDestinationDocument(serializer: Serializer, input: AnalyticsExportDestination) {
    ...
    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        input.s3BucketDestination?.let { field(S3BUCKETDESTINATION_DESCRIPTOR, it, ::serializeAnalyticsS3BucketDestinationDocument) }
    }
}
