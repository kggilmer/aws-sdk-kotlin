...
class PutObjectRetentionResponse private constructor(builder: BuilderImpl) {
    /**
    ...
    companion object {
        ...
        operator fun invoke(block: DslBuilder.() -> kotlin.Unit): PutObjectRetentionResponse = BuilderImpl().apply(block).build()
    ...
    fun copy(block: DslBuilder.() -> kotlin.Unit = {}): PutObjectRetentionResponse = BuilderImpl(this).apply(block).build()

    interface FluentBuilder {
        fun build(): PutObjectRetentionResponse
        /**
         * If present, indicates that the requester was successfully charged for the
         * request.
         */
    ...
    private class BuilderImpl() : FluentBuilder, DslBuilder {
        ...
        constructor(x: PutObjectRetentionResponse) : this() {
            this.requestCharged = x.requestCharged
        }

        override fun build(): PutObjectRetentionResponse = PutObjectRetentionResponse(this)
